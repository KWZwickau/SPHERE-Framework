...
$config = array(
    "storage" => "files",
    // ssdb, files, xcache, sqlite, memcache, memcached, redis, predis, apc, cookie, wincache
    "path" => sys_get_temp_dir(),
    // or in Windows: "C:/tmp/" or "/path/to/your/cache/folder/"
    "allow_search" => false,
    // change to true to turn on search method
    "overwrite" => "",
    // when your memcache server broken, simple put "files" here, and it will overwrite everything to files cache until u fixed ur server
);
...
$config = array(
    ...
    // ssdb, files, xcache, sqlite, memcache, memcached, redis, predis, apc, cookie, wincache
    "overwrite" => "files",
    // Any caching will be overwrite to files cache until your fix your server and removed this line
    "path" => sys_get_temp_dir()
    // or in Windows: "C:/tmp/"
);
CacheManager::setup($config);
