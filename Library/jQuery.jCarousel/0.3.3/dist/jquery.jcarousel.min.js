...
(function(t)
{
    ...
    i.parseTarget = function(t)
    {
        ...
        return e ? (t = parseInt(e[2],
                10) || 0, e[1] && (i = !0, "-=" === e[1] && (t *= -1))) : "object" != typeof t && (t = parseInt(t,
                10) || 0), {target: t, relative: i}
    ...
    }, i.base = function(s)
    {
        return {
            ...
            create: function()
            {
                return this._element.attr("data-" + s.toLowerCase(), !0).data(s,
                    this), !1 === this._trigger("create") ? this : (this._create(), this._trigger("createend"), this)
            },
            destroy: function()
            {
...
})(jQuery), function(t, i)
{
    ...
    t.jCarousel.plugin("jcarousel", {
        ...
        scroll: function(i, s, e)
        {
            ...
            if (r.relative) {
                ...
                if (r.target > 0) {
                    ...
                    if (g >= d && this.tail) {
                        this.inTail ? "both" === p || "last" === p ? this._scroll(0, s,
                            e) : t.isFunction(e) && e.call(this, !1) : this._scrollTail(s, e);
                    } else {
                        if (n = this.index(this._target), this.underflow && n === d && ("circular" === p || "both" === p || "last" === p) || !this.underflow && g === d && ("both" === p || "last" === p)) {
                            this._scroll(0,
                                s, e);
                        } else {
                            if (l = n + _, this.circular && l > d) {
                                for (f = d, h = this.items().get(-1); l > f++;) {
                                    h = this.items().eq(0), u = this._visible.index(h) >= 0, u && h.after(h.clone(!0).attr("data-jcarousel-clone",
                                        !0)), this.list().append(h), u || (c = {}, c[this.lt] = this.dimension(h), this.moveBy(c)), this._items = null;
                                }
                                this._scroll(h, s, e)
                            } else {
                    ...
                    if (this.inTail) {
                        ...
                        if (o = this.index(this._first), n = this.index(this._target), a = this.underflow ? n : o, l = a - _, 0 >= a && (this.underflow && "circular" === p || "both" === p || "first" === p)) {
                            this._scroll(d,
                                s, e);
                        } else {
                            if (this.circular && 0 > l) {
                                for (f = l, h = this.items().get(0); 0 > f++;) {
                                    h = this.items().eq(-1), u = this._visible.index(h) >= 0, u && h.after(h.clone(!0).attr("data-jcarousel-clone",
                                        !0)), this.list().prepend(h), this._items = null;
        ...
        moveBy: function(t, i)
        {
            ...
            return this.rtl && !this.vertical && (r = -1, this.relative && (n = this.list().width() - this.clipping())), t.left && (t.left = e.left + n + s(t.left) * r + "px"), t.top && (t.top = e.top + n + s(t.top) * r + "px"), this.move(t,
                i)
        },
        move: function(i, s)
        {
            ...
            o ? u.transform = "translate3d(" + (i.left || 0) + "," + (i.top || 0) + ",0)" : n ? u.transform = "translate(" + (i.left || 0) + "," + (i.top || 0) + ")" : t.extend(u,
                i), r && l > 0 && a.one("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd",
                h), a.css(u), 0 >= l && a.each(function()
            {
                h.call(this)
            })
        },
        _scroll: function(i, s, e)
        {
            ...
            if ("object" != typeof i ? i = this.items().eq(i) : i.jquery === void 0 && (i = t(i)), 0 === i.length) {
                return t.isFunction(e) && e.call(this,
                    !1), this;
            }
            ...
            if (f && (h /= 2, u /= 2), u > h) {
                for (; ;) {
                    if (e = this.items().eq(++a), 0 === e.length) {
                        ...
                        if (r = this._visible.index(e) >= 0, r && e.after(e.clone(!0).attr("data-jcarousel-clone",
                                !0)), this.list().append(e), !r) {
                            var _ = {};
        ...
        _update: function(i)
        {
            ...
            }, n = this.index(i.first || r.first) < this.index(r.first), o = function(s)
            {
                ...
                }), n ? o = o.reverse() : l = l.reverse(), e._trigger(s + "in", t(o)), e._trigger(s + "out",
                    t(l)), e["_" + s] = i[s]
            };
            for (s in i) {
                o(s);
...
}(jQuery, window), function(t)
{
    ...
    t.jcarousel.fn.scrollIntoView = function(i, s, e)
    {
        ...
        if (r = n.relative ? 0 > n.target ? Math.max(0,
                o + n.target) : l + n.target : "object" != typeof n.target ? n.target : this.index(n.target), o > r) {
            return this.scroll(r,
                s, e);
        }
        if (r >= o && l >= r) {
            return t.isFunction(e) && e.call(this, !1), this;
    ...
    t.jCarousel.plugin("jcarouselControl", {
        _options: {target: "+=1", event: "click", method: "scroll"}, _active: null, _init: function()
        {
            ...
            }, this), this.onReload = t.proxy(this._reload, this), this.onEvent = t.proxy(function(i)
            {
                ...
                t.isFunction(s) ? s.call(this) : this.carousel().jcarousel(this.options("method"),
                    this.options("target"))
            }, this)
        }, _create: function()
        {
            this.carousel().one("jcarousel:destroy", this.onDestroy).on("jcarousel:reloadend jcarousel:scrollend",
                this.onReload), this._element.on(this.options("event") + ".jcarouselcontrol",
                this.onEvent), this._reload()
        }, _destroy: function()
        {
            this._element.off(".jcarouselcontrol", this.onEvent), this.carousel().off("jcarousel:destroy",
                this.onDestroy).off("jcarousel:reloadend jcarousel:scrollend", this.onReload)
        }, _reload: function()
        {
...
}(jQuery), function(t)
{
    ...
    t.jCarousel.plugin("jcarouselPagination", {
        ...
        {
            this.carousel().one("jcarousel:destroy", this.onDestroy).on("jcarousel:reloadend",
                this.onReload).on("jcarousel:scrollend", this.onScroll), this._reload()
        }, _destroy: function()
        {
        ...
        }, _reload: function()
        {
            ...
            if (this._pages = {}, this._items = {}, t.isFunction(i) && (i = i.call(this)), null == i) {
                ...
                for (var s, e = parseInt(i,
                        10) || 0, r = this._getCarouselItems(), n = 1, o = 0; ;) {
        ...
        }, _update: function()
        {
            ...
            }), this._currentPage !== i && (this._trigger("inactive",
                this._items[this._currentPage]), this._trigger("active", this._items[i])), this._currentPage = i
        }, items: function()
        {
            return this._items
...
}(jQuery), function(t)
{
    ...
    t.jCarousel.plugin("jcarouselAutoscroll", {
        ...
        {
            return this.stop(), this.carousel().one("jcarousel:animateend",
                this.onAnimateEnd), this._timer = setTimeout(t.proxy(function()
            {
