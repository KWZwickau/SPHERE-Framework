...
!function( a )
{
    ...
    }, K = function( a, b )
    {
        return this instanceof K ? (this.id = "" + g++, h[this.id] = {
            ...
            N.debug ), K.config( b )), this.options = K.config(), "boolean" != typeof e.disabled && (e.disabled = !J()), e.disabled === !1 && e.outdated !== !0 && null === e.bridge && (e.outdated = !1, e.ready = !1, O()), void 0) : new K( a,
            b )
    };
