        ...
        $carousel
            .one( 'slide.bs.carousel', function( e )
            {
                ...
                setTimeout( function()
                {
                    ...
                    assert.ok( $carousel.find( '.carousel-indicators li:eq(0)' ).is( '.active' ),
            ...
            .one( 'slid.bs.carousel', function()
            {
                setTimeout( function()
                {
                    ...
                    assert.ok( $carousel.find( '.carousel-indicators li:eq(1)' ).is( '.active' ),
                ...
                $carousel
                    .one( 'slid.bs.carousel', function()
                    {
                        ...
                        $carousel
                            .one( 'slid.bs.carousel', function()
                            {
                                assert.strictEqual( getActiveId(), 'one',
                ...
                $carousel
                    .one( 'slid.bs.carousel', function()
                    {
                        ...
                        $carousel
                            ...
                            .bootstrapCarousel( 'next' );
                        assert.strictEqual( getActiveId(), 'three',
