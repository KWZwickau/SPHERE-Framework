...
!function (V) {
            ...
            if (!vn(t) || !ur(t)) {
                ...
                if (!1 === _n(t)) {
                    if (En(t) && 0 < t.nodeValue.length) {
                        ...
                        if (vn(t) && (1 === (r = t.childNodes).length && ur(r[0]) && t.parentNode.insertBefore(r[0], t), r.length || tr(Ct.fromDom(t)))) return;
                    e.remove(t)
                }
                var i, a, u;
                return t
        ...
        if (uo && !r) {
            if (o = Ho.exec(e)) if (a = o[1]) {
                if (9 === u) {
                    ...
                    if (t.ownerDocument && (i = t.ownerDocument.getElementById(a)) && lo(t, i) && i.id === a) return n.push(i), n
            } else {
                ...
                return 1 === p && 0 === g ? function (e) {
                    ...
                    if (l) {
                        ...
                        if (s = [v ? l.firstChild : l.lastChild], v && d) {
                            ...
                            if (d && (r = (e[fo] || (e[fo] = {}))[m]) && r[0] === po) a = r[1]; else for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[fo] || (i[fo] = {}))[m] = [po, a]), i !== e));) ;
    ...
    var ai = V.document, ui = Array.prototype.push, si = Array.prototype.slice,
        ...
        di = function (e) {
            ...
            var o;
            if (mi(t)) t = pi(t, Ri(e[0])); else
                if (t.length && !t.nodeType) {
    ...
    Ni.fn = Ni.prototype = {
        constructor: Ni, selector: "", context: null, length: 0, init: function (e, t) {
            ...
            if ("object" == typeof n) _i(n, function (e, t) {
                ...
                if (di(r)) n = t(n), "number" != typeof r || yi[n] || (r = r.toString() + "px"), i.each(function () {
                    var e = this.style;
    ...
    Ii = undefined, Mi = zi, Fi = ji, Ui = undefined, function (e) {
        if ("object" == typeof Mi && void 0 !== Fi) Fi.exports = e(); else
            if ("function" == typeof Ii && Ii.amd) Ii([], e); else {
        ...
        var X = W.comment ? W.comment : e, Y = W.cdata ? W.cdata : e, G = W.text ? W.text : e,
            ...
            n = function (m, e) {
                ...
                for (var t, n, r, p, o, i, a, g, u, s, c, l, f, h, v, d, y, b, C, w = m.html, x = 0, S = [], N = 0, E = xr.decode, k = yt.makeMap("src,href,data,background,formaction,poster,xlink:href"), _ = /((java|vb)script|mhtml):/i, T = "html" === e ? 0 : 1, R = function (e) {
                    ...
                    var q = t[0];
                    if (x < t.index && A(E(w.substr(x, t.index - x))), n = t[7]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), R(n); else
                        if (n = t[8]) {
    ...
    var Uf, zf, jf, Hf, Vf, qf = Ff, $f = function (e, t) {
            ...
            var o, i, a, u, s;
            if (t.format = n, t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) o = yt.trim(Wf(e.serializer, r.innerHTML)); else
                if ("text" === t.format) o = Su(r.innerText || r.textContent); else {
        ...
        _m = {
            ...
            if (t) xp(e, t, n); else
                if (!(t = bl(e.getBody(), o.getStart()))) for (; t = r.get(yp);) xp(e, t, !1)
        }, Np = function (e, t) {
    ...
    var Op, Bp, Pp = yt.each, Lp = function (e) {
        ...
        Wp = function (e, t, n) {
            ...
            if (e) if (Bl(e)) {
                ...
                if ("false" !== a.getContentEditable(t.getNode())) t.isCollapsed() && m.inline && !ff(s).length ? kp(s, c, l, f) : (yf(t, !0, function () {
                    vf(s, n)
            ...
            if ("false" !== i.getContentEditable(t.getNode())) {
                if (R) {
                    if (r) Bl(r) ? d(T, r) || ((e = i.createRng()).setStartBefore(r), e.setEndAfter(r), a(i, of(E, e, T), 0, !0)) : a(i, r, 0, !0); else
                        if (o && R.inline && !ff(E).length) !function (e, t, n) {
    ...
    var Lh = function HE(r, o) {
        ...
        var r, o, i, a, u, s = n;
        if (s.caretPositionFromPoint) (o = s.caretPositionFromPoint(e, t)) && ((r = n.createRange()).setStart(o.offsetNode, o.offset), r.collapse(!0)); else
            if (n.caretRangeFromPoint) r = n.caretRangeFromPoint(e, t); else
                if (s.body.createTextRange) {
    ...
    var cy, ly, fy = yt.each, dy = Ta.DOM, my = function (e, t) {
            var n, o, r, m = t && t.schema || Br({}), p = function (e) {
                ...
                if (d) f === d ? (o = e[0], e = e.slice(1)) : o = d; else
                    if (l) o = e[0], e = e.slice(1); else
                        if (!t) return n;
    ...
    var Lb = function (o, i, a, e, u, t) {
        ...
        uw = function (e, t, n, r) {
            ...
            if (n !== e.getBody()) {
                ...
                if (Xw(n, r, !0) && Xw(n, r, !1)) $w(n, "LI") ? i.insertAfter(l, Kw(n)) : i.replace(l, n); else
                    if (Xw(n, r, !0)) $w(n, "LI") ? (i.insertAfter(l, Kw(n)), l.appendChild(i.doc.createTextNode(" ")), l.appendChild(n)) : n.parentNode.insertBefore(l, n); else
                        if (Xw(n, r, !1)) i.insertAfter(l, Kw(n)); else {
                            n = Kw(n);
                            var f = a.cloneRange();
                ...
                g = a.selection.getRng(), h = function (e) {
                    ...
                    for (En(u) && (e && 0 === r ? o.prev() : e || r !== u.nodeValue.length || o.next()); t = o.current();) {
                        if (vn(t)) {
                            ...
                            if (En(t) && !ar(t.nodeValue)) return !1;
                        e ? o.prev() : o.next()
                    }
                    return !0
                }, y = function () {
            ...
            if (w) {
                ...
                if ("LI" !== E || C || (o = (s = o).parentNode, c = E), /^(LI|DT|DD)$/.test(c) && d.isEmpty(s)) Yw(a, h, o, s, l); else
                    if (!l || s !== a.getBody()) l = l || "P", ku(s) ? (n = Lu(s), d.isEmpty(s) && Gw(s), tx(a, n), Vw(a, n)) : v() ? y() : v(!0) ? (n = s.parentNode.insertBefore(h(), s), Vw(a, Jw(s, "HR") ? n : s)) : ((N = (S = g).cloneRange()).setStart(S.startContainer, Zw(!0, S.startContainer, S.startOffset)), N.setEnd(S.endContainer, Zw(!1, S.endContainer, S.endOffset)), (t = N.cloneRange()).setEndAfter(s), r = t.extractContents(), x = r, z(Ja(Ct.fromDom(x), Et), function (e) {
                        var t = e.dom();
        ...
        return mt.ceFalse && function () {
            ...
            (n = g).on("tap", function (e) {
                ...
                if ((t === v || "HTML" === t.nodeName || g.dom.isChildOf(t, v)) && !1 !== xh(g, e.clientX, e.clientY)) {
                    var n = vS(g, t);
                    if (n) hS(n) ? (e.preventDefault(), s(Qb(g, n))) : (c(), gS(n) && e.shiftKey || xv(e.clientX, e.clientY, g.selection.getRng()) || (w(), g.selection.placeCaretAt(e.clientX, e.clientY))); else
                        if (!1 === Ec(t)) {
                            c(), w();
