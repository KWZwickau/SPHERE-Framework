...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exsl="http://exslt.org/common"
                    ...
                    <xsl:for-each select="package/subpackage/class">
                        ...
                        <xsl:variable name="link">
                            ...
                            <xsl:if test="not($subpackage.name='')">
                                <xsl:value-of select="translate($subpackage.name,'._','//')"/>
                                <xsl:text>/</xsl:text>
                            </xsl:if>
                            <xsl:value-of select="@name"/>
                            <xsl:text>.html</xsl:text>
    ...
    <xsl:template name="pageHeader">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td style="text-align:right">Designed for use with<a href='http://www.phpunit.de'>PHPUnit</a>,
                    <a href='http://www.xdebug.org/'>Xdebug</a>
