...
class RSA
{
        ...
        switch ($this->privateKeyFormat) {
            ...
            default: // eg. self::PRIVATE_FORMAT_PKCS1
                ...
                foreach ($raw as $name => $value) {
                    $components[$name] = pack('Ca*a*', self::ASN1_INTEGER, $this->_encodeLength(strlen($value)),
                        $value);
                }
                ...
                if ($num_primes > 2) {
                    ...
                    $RSAPrivateKey .= pack('Ca*a*', self::ASN1_SEQUENCE, $this->_encodeLength(strlen($OtherPrimeInfos)),
                        $OtherPrimeInfos);
                }

                $RSAPrivateKey = pack('Ca*a*', self::ASN1_SEQUENCE, $this->_encodeLength(strlen($RSAPrivateKey)),
                    $RSAPrivateKey);
    ...
    function _convertPublicKey($n, $e)
    {
        ...
        switch ($this->publicKeyFormat) {
            ...
            default: // eg. self::PUBLIC_FORMAT_PKCS1_RAW or self::PUBLIC_FORMAT_PKCS1
                ...
                // }
                $components = array(
                    'modulus'        => pack('Ca*a*', self::ASN1_INTEGER, $this->_encodeLength(strlen($modulus)),
                        $modulus),
                    'publicExponent' => pack('Ca*a*', self::ASN1_INTEGER, $this->_encodeLength(strlen($publicExponent)),
                        $publicExponent)
                );
    ...
    public function getPublicKeyFingerprint($algorithm = 'md5')
    {
        ...
        $RSAPublicKey = pack('Na*Na*Na*', strlen('ssh-rsa'), 'ssh-rsa', strlen($publicExponent), $publicExponent,
