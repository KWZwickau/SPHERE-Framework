...
class SSH2
{
    ...
    function _get_binary_packet()
    {
        ...
        if ($this->hmac_check !== false) {
            ...
            if ($hmac === false || strlen($hmac) != $this->hmac_size) {
                ...
                $this->bitmap = 0;
                return false;
            } elseif ($hmac != $this->hmac_check->hash(pack('NNCa*', $this->get_seq_no, $packet_length, $padding_length,
                    $payload.$padding))
            ) {
    ...
    function _key_exchange($kexinit_payload_server)
    {
        ...
        $compression_algorithm = $this->_array_intersect_first($compression_algorithms,
