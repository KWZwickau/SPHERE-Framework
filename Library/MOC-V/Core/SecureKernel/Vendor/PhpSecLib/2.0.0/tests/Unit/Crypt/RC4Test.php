...
class Unit_Crypt_RC4Test extends PhpseclibTestCase
{
    ...
    public function engineVectors()
    {
        ...
        $tests = array(
            ...
            array(
                'key'    => pack('H*', '0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20'),
                // 256-bit key
                'output' => array(
    ...
    public function testVectors($engine, $engineName, $key, $offset, $expected)
    {
        ...
        $this->assertEquals(bin2hex(substr($result, -16)), $expected,
            "Failed asserting that key $key yielded expected output at offset $offset in $engineName engine");
    }
}
