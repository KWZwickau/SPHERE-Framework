...
use MOC\V\Core\FileSystem\Vendor\Universal\Stream;
 ...
 */
class UniversalStream extends Bridge implements IBridgeInterface
{
    ...
    public function __construct(FileParameter $FileLocation, FileParameter $FileName = null)
    {
        ...
        parent::__construct();
        $this->Instance = new Stream($FileLocation->getFile(), ( $FileName ? $FileName->getFile() : null ));
    }
