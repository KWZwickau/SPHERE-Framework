                ...
                case 0x02:
                    ...
                    switch ($oSprm->isPmd) {
                        ...
                        case 0x70:
                            ...
                            $pos += 1;
                            $green = str_pad(dechex(self::getInt1d($this->dataWorkDocument, $pos)), 2, '0',
                                STR_PAD_LEFT);
                            $pos += 1;
                            $blue = str_pad(dechex(self::getInt1d($this->dataWorkDocument, $pos)), 2, '0',
                                STR_PAD_LEFT);
                            $pos += 1;
                            $pos += 1;
                        ...
                        case 0xF007:
                            ...
                            switch ($embeddedBlipRH['recType']) {
                                ...
                                case self::OFFICEARTBLIPJPEG:
                                    ...
                                    $oStylePrl->image['data'] = substr($this->dataData, $sprmCPicLocation,
                                        $embeddedBlipRH['recLen']);
                            ...
                            if (empty( $sHYPERLINK )) {
                                ...
                                if (ord($sText[0]) == 1) {
                                    if (isset( $oCharacters->style->image )) {
                                        $fileImage = tempnam(sys_get_temp_dir(),
                                                'PHPWord_MsDoc').'.'.$oCharacters->style->image['format'];
                                        file_put_contents($fileImage, $oCharacters->style->image['data']);
                                        $oSection->addImage($fileImage, array(
                                            'width'  => $oCharacters->style->image['width'],
