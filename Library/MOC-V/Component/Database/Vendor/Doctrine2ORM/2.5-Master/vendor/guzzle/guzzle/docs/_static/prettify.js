...
(function()
{
    function L( a )
    {
        function m( a )
        {
            ...
            var b = a.charAt( 1 );
            return (f = r[b]) ? f : "0" <= b && b <= "7" ? parseInt( a.substring( 1 ),
                8 ) : b === "u" || b === "x" ? parseInt( a.substring( 2 ), 16 ) : a.charCodeAt( 1 )
        }
        ...
        function h( a )
        {
            for (var f = a.substring( 1,
                a.length - 1 ).match( /\\u[\dA-Fa-f]{4}|\\x[\dA-Fa-f]{2}|\\[0-3][0-7]{0,2}|\\[0-7]{1,2}|\\[\S\s]|[^\\]/g ), a =
        ...
        function e( a )
        {
            for (var l = a.d, p = [
                ...
                if (typeof b ===
                    ...
                    if ((c = b.length >= 5 && "lang-" === b.substring( 0,
                            5 )) && !(o && typeof o[1] === "string")) {
                        c = !1, b = "src";
                    }
                    c || (r[f] = b)
                }
    ...
    function D( a, m )
    {
        ...
        for (var n = Math.max( 0,
                m - 1 | 0 ) || 0, g = 0, z = d.length; g < z; ++g) {
