...
class CoreMacros extends MacroSet
{
    ...
    public function finalize()
    {
        ...
        return array(
            'list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, '
    ...
    public function macroEndForeach( MacroNode $node, PhpWriter $writer )
    {
        ...
        if (preg_match( '#\W(\$iterator|include|require|get_defined_vars)\W#',
    ...
    public function macroDump( MacroNode $node, PhpWriter $writer )
    {
        ...
        return 'Nette\Diagnostics\Debugger::barDump('.( $node->args ? "array(".$writer->write( '%var',
                $args )." => $args)" : 'get_defined_vars()' )
