...
class Texy extends TexyObject
{
    ...
    public $encoding = 'utf-8'; // all classes and id are allowed
    /** @var array  Texy! syntax configuration */
    public $allowed = array();  // all inline styles are allowed
    ...
    public $allowedStyles = Texy::ALL; // disable URL scheme filter
