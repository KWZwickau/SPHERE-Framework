...
class Smarty_Internal_Templateparser#line 80 "smarty_internal_templateparser.php"
{
    ...
    private $_string;
    private $lex;                    /* Index of top element in stack */
    private $internalError = false;                 /* Shifts left before out of the error */
    private $strip = false;  /* The parser's stack */
    private $_retvalue;
    ...
    function yy_r4()
    {
        ...
        if ($this->compiler->has_code) {
            ...
            $this->_retvalue = new _smarty_tag($this,
                $this->compiler->processNocacheCode($tmp.$this->yystack[$this->yyidx + -1]->minor, true));
        } else {
            $this->_retvalue = null;
        }
        $this->compiler->has_variable_string = false;
    ...
    function yy_r31()
    {
        ...
        $this->_retvalue = $this->compiler->compileTag('assign', array_merge(array(
            ...
            array('smarty_internal_index' => $this->yystack[$this->yyidx + -3]->minor['smarty_internal_index']));
    }
    ...
    function yy_r35()
    {
        ...
        $this->_retvalue .= $this->compiler->compileTag('private_modifier', array(),
                array('modifierlist' => $this->yystack[$this->yyidx + -1]->minor, 'value' => 'ob_get_clean()')).'?>';
    }
    ...
    function yy_r36()
    {
        ...
        $this->_retvalue = '<?php ob_start();?>'.$this->compiler->compileTag($this->yystack[$this->yyidx + -4]->minor,
                $this->yystack[$this->yyidx + 0]->minor,
                array('object_method' => $this->yystack[$this->yyidx + -2]->minor)).'<?php echo ';
        $this->_retvalue .= $this->compiler->compileTag('private_modifier', array(),
                array('modifierlist' => $this->yystack[$this->yyidx + -1]->minor, 'value' => 'ob_get_clean()')).'?>';
    }
    ...
    public function compileVariable($variable)
    {
        ...
        if (strpos($variable, '(') == 0) {
            ...
            $var = trim($variable, '\'');
            $this->compiler->tag_nocache = $this->compiler->tag_nocache | $this->template->getVariable($var, null,
                    true, false)->nocache;
