                ...
                switch (Y) {
                    ...
                    case a.NOTATION.UPDIAGONALSTRIKE:
                        if (b.useVML) {
                            ...
                            G = this.HTMLvmlElement( g, "line",
                                {from: "0," + this.HTMLpx( K + P - N ), to: this.HTMLpx( o ) + ",0"} )
                        } else {
                            if (!S) {
                                S = this.HTMLsvg( z, K, P, o, N, j.mathcolor )
                            }
                            this.HTMLsvgElement( S.firstChild, "line",
                                {x1: 1, y1: this.HTMLpx( K + P - N ), x2: this.HTMLpx( o - N ), y2: this.HTMLpx( N )} )
                        }
                        break;
                    ...
                    case a.NOTATION.DOWNDIAGONALSTRIKE:
                        if (b.useVML) {
                            ...
                            this.HTMLvmlElement( g, "line",
                                {from: "0,0", to: this.HTMLpx( o ) + "," + this.HTMLpx( K + P - N )} )
                        } else {
                            if (!S) {
                                S = this.HTMLsvg( z, K, P, o, N, j.mathcolor )
                            }
                            this.HTMLsvgElement( S.firstChild, "line",
                                {x1: 1, y1: this.HTMLpx( N ), x2: this.HTMLpx( o - N ), y2: this.HTMLpx( K + P - N )} )
                        }
                        break;
                    case a.NOTATION.PHASORANGLE:
                        ...
                        if (b.useVML) {
                            ...
                            this.HTMLvmlElement( g, "shape", {
                                ...
                                path: "m " + this.HTMLpt( X + N / 2, N / 2 ) + " l " + this.HTMLpt( N / 2,
                                    K + P - N ) + " " + this.HTMLpt( o - N / 2, K + P - N ) + " e",
                            ...
                            this.HTMLsvgElement( S.firstChild, "path",
                                {d: "M " + this.HTMLpx( X ) + ",1L 1," + this.HTMLpx( K + P - N ) + " L " + this.HTMLpx( o ) + "," + this.HTMLpx( K + P - N )} );
                    ...
                    case a.NOTATION.RADICAL:
                        if (b.useVML) {
                            ...
                            this.HTMLvmlElement( g, "shape", {
                                style: {width: this.HTMLpx( o ), height: this.HTMLpx( K + P )},
                                path: "m " + this.HTMLpt( N / 2, 0.6 * (K + P) ) + " l " + this.HTMLpt( X,
                                    K + P - N ) + " " + this.HTMLpt( 2 * X, N / 2 ) + " " + this.HTMLpt( o,
                                    N / 2 ) + " e",
                                coordsize: this.HTMLpt( o, K + P )
                            } );
                            M = X
                            ...
                            this.HTMLsvgElement( S.firstChild, "path",
                                {d: "M 1," + this.HTMLpx( 0.6 * (K + P) ) + " L " + this.HTMLpx( X ) + "," + this.HTMLpx( K + P ) + " L " + this.HTMLpx( 2 * X ) + ",1 L " + this.HTMLpx( o ) + ",1"} );
                    ...
                    case a.NOTATION.LONGDIV:
                        if (b.useVML) {
                            ...
                            this.HTMLsvgElement( S.firstChild, "path",
                                {d: "M " + this.HTMLpx( o ) + ",1 L 1,1 a" + this.HTMLpx( X ) + "," + this.HTMLpx( (K + P) / 2 - N ) + " 0 0,1 1," + this.HTMLpx( K + P - 2 * N )} );
