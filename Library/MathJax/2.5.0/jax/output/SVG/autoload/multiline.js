...
MathJax.Hub.Register.StartupHook( "SVG Jax Ready", function()
{
    ...
    a.mrow.Augment( {
        SVGmultiline: function( k )
        {
            ...
            var n = ((o.type === "math" && o.Get( "display" ) === "block") || o.type === "mtd");
            o.isMultiline = true;
            var p = this.getValues( "linebreak", "linebreakstyle", "lineleading", "linebreakmultchar", "indentalign",
                "indentshift", "indentalignfirst", "indentshiftfirst", "indentalignlast", "indentshiftlast" );
            ...
            var g = {n: 0, Y: 0, scale: this.scale || 1, isTop: n, values: {}, VALUES: p}, m = this.SVGgetAlign( g,
                {} ), i = this.SVGgetShift( g, {}, m ), h = [], j = {
                index: [],
                penalty: e.nobreak,
                w: 0,
                W: i,
            ...
            while (this.SVGbetterBreak( j, g ) && (j.scanW >= f.linebreakWidth || j.penalty === e.newline)) {
    ...
    a.mbase.Augment( {
        SVGlinebreakPenalty: e, SVGbetterBreak: function( j, g )
        {
            if (this.isToken) {
                return false
            }
        ...
        }, SVGaddLine: function( l, h, k, g, p, n )
        {
            ...
            if (g.n > 0) {
                ...
                var j = (g.values.lineleading == null ? g.VALUES : g.values).lineleading * g.scale;
        ...
        }, SVGmoveLine: function( p, g, k, o, h )
        {
            ...
            if (m === l && p.length > 1) {
                this.data[m].SVGmoveSlice( p.slice( 1 ), g.slice( 1 ), k, o, h, "paddingLeft" )
            } else {
                var n = o.last;
                o.last = false;
                while (m < l) {
        ...
        {
            if (!(j.first || j.last) || (j.first && j.values.linebreakstyle === a.LINEBREAKSTYLE.BEFORE) || (j.last && i.linebreakstyle === a.LINEBREAKSTYLE.AFTER)) {
    ...
    a.mfenced.Augment( {
        ...
        }, SVGmoveLine: function( h, m, p, g, r )
        {
            ...
            if (o === n && h.length > 1) {
                this.data[this.dataI[o]].SVGmoveSlice( h.slice( 1 ), m.slice( 1 ), p, g, r, "paddingLeft" )
            } else {
                var q = g.last;
                g.last = false;
                var l = this.dataI[o];
    ...
    a.msubsup.Augment( {
        ...
        }, SVGmoveLine: function( i, j, m, h, o )
        {
            if (this.data[this.base]) {
                if (i.length > 1) {
                    this.data[this.base].SVGmoveSlice( i.slice( 1 ), j.slice( 1 ), m, h, o, "paddingLeft" )
                } else {
                    if (j.length <= 1) {
                        this.data[this.base].SVGmove( m, h, o )
                    } else {
                        this.data[this.base].SVGmoveSlice( [], j.slice( 1 ), m, h, o, "paddingRight" )
                    }
                }
            }
            if (j.length === 0) {
    ...
    a.mmultiscripts.Augment( {
        ...
        }, SVGmoveLine: function( i, k, n, h, p )
        {
            ...
            if (this.data[this.base]) {
                if (i.length > 1) {
                    this.data[this.base].SVGmoveSlice( i.slice( 1 ), k.slice( 1 ), n, h, p, "paddingLeft" )
                } else {
                    if (k.length <= 1) {
                        this.data[this.base].SVGmove( n, h, p )
                    } else {
                        this.data[this.base].SVGmoveSlice( [], k.slice( 1 ), n, h, p, "paddingRight" )
                    }
                }
            }
            if (k.length === 0) {
    ...
    a.mo.Augment( {
        SVGbetterBreak: function( i, g )
        {
            ...
            var q = this.getValues( "linebreak", "linebreakstyle", "lineleading", "linebreakmultchar", "indentalign",
                "indentshift", "indentalignfirst", "indentshiftfirst", "indentalignlast", "indentshiftlast", "texClass",
                "fence" );
            ...
            if (g.n === 0 && (q.indentshiftfirst !== g.VALUES.indentshiftfirst || q.indentalignfirst !== g.VALUES.indentalignfirst)) {
            ...
            if ((q.linebreakstyle === a.LINEBREAKSTYLE.AFTER && q.texClass === a.TEXCLASS.OPEN) || q.texClass === a.TEXCLASS.CLOSE) {
                o += e.close
            }
    ...
    a.mspace.Augment( {
        SVGbetterBreak: function( h, g )
        {
            ...
            var p = e[m];
            if (m === a.LINEBREAK.AUTO && n >= e.spacelimit * 1000 && !this.mathbackground && !this.backrgound) {
