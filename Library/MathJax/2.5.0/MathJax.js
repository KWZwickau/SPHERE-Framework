...
if (document.getElementById && document.childNodes && document.createElement) {
    if (!(window.MathJax && MathJax.Hub)) {
        ...
        MathJax.Hub = {
            ...
            takeAction: function( g, d, h )
            {
                ...
                if (c.count) {
                    ...
                    a.Push( ["Post", this.signal, ["Begin " + g, f]], ["Post", this.signal, ["Begin Math", f, g]],
                        ["prepareScripts", this, g, f, e], ["Post", this.signal, ["Begin Math Input", f, g]],
                        ["processInput", this, e], ["Post", this.signal, ["End Math Input", f, g]], b,
                        ["prepareOutput", this, e, "preProcess"], b, ["Post", this.signal, ["Begin Math Output", f, g]],
                        ["processOutput", this, e], ["Post", this.signal, ["End Math Output", f, g]], b,
                        ["prepareOutput", this, e, "postProcess"], b, ["Post", this.signal, ["End Math", f, g]],
            ...
            processMessage: function( d, b )
            {
                ...
                var c = (b === "Output" ? ["TypesetMath", "Typesetting math: %1%%"] : [
                    "ProcessMath",
                    "Processing math: %1%%"
                ]);
            ...
            formatError: function( b, e )
            {
                ...
                var c = MathJax.HTML.Element( "span", {className: "MathJax_Error", jaxID: "Error", isMathJax: true},
                    a );
        ...
        MathJax.Hub.Startup = {
            ...
            Cookie: function()
            {
                return this.queue.Push( ["Post", this.signal, "Begin Cookie"],
                ...
                }, loadComplete: function( i )
                {
                    if (i === "config.js") {
                        ...
                        h.Push( c.Register.StartupHook( "End Config", {} ),
                            ["Post", c.Startup.signal, this.id + " Jax Config"], ["Config", this],
                            ...
                            ], ["Post", c.Startup.signal, this.id + " Jax Startup"], ["Startup", this],
