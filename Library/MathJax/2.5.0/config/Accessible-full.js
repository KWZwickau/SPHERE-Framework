...
(function( b, e )
{
    ...
    b.Register.StartupHook( "HTML-CSS Jax Config", function()
    {
        b.Config( {
            "HTML-CSS": {
                styles: {
                    ".MathJax .noError": b.Insert( {"vertical-align": (b.Browser.isMSIE && a.multiLine ? "-2px" : "")},
                        a.style )
                }
            }
        } )
    ...
    b.Register.StartupHook( "SVG Jax Config", function()
    {
        b.Config( {
            SVG: {
                styles: {
                    ".MathJax_SVG .noError": b.Insert( {"vertical-align": (b.Browser.isMSIE && a.multiLine ? "-2px" : "")},
                        a.style )
                }
            }
        } )
    ...
    b.Register.StartupHook( "CommonHTML Jax Config", function()
    {
        b.Config( {
            CommonHTML: {
                styles: {
                    ".MathJax_CHTML .noError": b.Insert( {"vertical-align": (b.Browser.isMSIE && a.multiLine ? "-2px" : "")},
                        a.style )
                }
            }
        } )
...
(function( d, c, i )
{
    ...
    var a = MathJax.Object.Subclass( {
        ...
        UnderOver: function( n, q, l )
        {
            ...
            m.SetData( m[p],
                this.mmlToken( h.mo( h.entity( "#x" + q ) ).With( {stretchy: true, accent: (p === "under")} ) ) );
            if (l) {
        ...
        MmlToken: function( n )
        {
            var o = this.GetArgument( n ), l = this.GetBrackets( n, "" ).replace( /^\s+/,
                "" ), r = this.GetArgument( n ), q = {attrNames: []}, m;
        ...
        Array: function( m, o, t, r, s, n, l, p )
        {
            ...
            if (u.match( /[|:]/ )) {
                ...
                q.arraydef.columnlines = u.split( "" ).join( " " ).replace( /[^|: ]/g, "none" ).replace( /\|/g,
                    "solid" ).replace( /:/g, "dashed" )
            }
            if (o) {
...
MathJax.Hub.Register.StartupHook( "TeX Jax Ready", function()
{
    ...
    g.Parse.Augment( {
        ...
        }, CFrac: function( k )
        {
            ...
            var i = b.mfrac( g.Parse( "\\strut\\textstyle{" + j + "}", this.stack.env ).mml(),
...
(function( c, d )
{
            ...
            if (j.firstChild.nodeName.toLowerCase() === "html") {
                ...
                if (f && f.textContent === "XML parsing error" && f.nextSibling) {
                    c.Error( [
                        "ParsingError",
                        "Error parsing MathML: %1",
                        String( f.nextSibling.nodeValue ).replace( /fatal parsing error: /, "" )
                    ] )
                }
            }
    ...
    c.Augment( {
        ...
        createParser: function()
        {
            ...
            this.div = MathJax.Hub.Insert( document.createElement( "div" ),
                {style: {visibility: "hidden", overflow: "hidden", height: "1px", position: "absolute", top: 0}} );
    ...
    {
        e.math = (typeof(e.math) === "string" ? c.prefilterMath( e.math, e.script ) : c.prefilterMathML( e.math,
            e.script ))
    } );
    c.Parse.Entity = {
        ApplyFunction: "\u2061",
...
(function( l, c, g, e )
{
    ...
    l.Augment( {
        ...
        Startup: function()
        {
            ...
            if (!c.Browser.hasMathPlayer) {
                this.EmExSpan = e.Element( "span", {style: {position: "absolute", "font-size-adjust": "none"}},
        ...
        preTranslate: function( o )
        {
            ...
            for (u = 0; u < p; u++) {
                ...
                A = e.Element( x, {className: "MathJax_MathML", id: n.inputID + "-Frame"}, [
                    [
                        "span",
                        {
        ...
        MSIEoverlay: function( m )
        {
            ...
            e.addElement( m, "span", {style: {display: "inline-block", width: 0, height: 0, position: "relative"}}, [
                [
                    "span",
                    {
                        isMathJax: true,
    ...
    c.Register.StartupHook( "mml Jax Ready", function()
    {
        ...
        f.mbase.Augment( {
            ...
            {
                var p = (document.createElementNS ? document.createElementNS( l.MMLnamespace,
                    o ) : (c.Browser.mpNamespace ? document.createElement( "m:" + o ) : document.createElement( o )));
                p.isMathJax = true;
                return p
            }
        } );
                    ...
                    if (l.tableLabelBug) {
                        ...
                        if (this.parent.nMMLhasLabels && p.firstChild) {
                            if (o || u !== "r") {
                                j( "Left", p.firstChild );
                                if (s !== "l") {
                                    p.insertBefore( this.NativeMMLelement( "mtd" ),
                                        p.firstChild ).setAttribute( "style", "padding:0" )
                                }
                                if (u === "l") {
                                    p.insertBefore( this.NativeMMLelement( "mtd" ),
                                        p.firstChild ).setAttribute( "style", "padding:0" )
                    ...
                    if (l.tableLabelBug && this.data[0]) {
                        ...
                        if (p || z !== "r") {
                            ...
                            if (x !== "l") {
                                ...
                                o -= B;
                                t.insertBefore( this.NativeMMLelement( "mtd" ), t.firstChild ).setAttribute( "style",
                                    "padding:0;width:" + B + "%" )
                            }
                            if (z === "l") {
                        ...
                        if (p || z !== "l") {
                            j( "Right", t.lastChild );
                            if (x !== "r") {
                                t.appendChild( this.NativeMMLelement( "mtd" ) ).setAttribute( "style",
                                    "padding:0;width:" + o + "%" )
                            }
                            if (z === "r") {
                                if (z !== x) {
                ...
                if (t.nMMLhasLabels) {
                    ...
                    if (t.nMMLlaMatch) {
                        if (y.parentNode.parentNode.nodeName.toLowerCase() === "div") {
                            y.parentNode.parentNode.style.setProperty( "margin-" + c.config.displayAlign, "0px",
                                "important" )
                        }
                    }
                }
        ...
        f.mmultiscripts.Augment( {
            toNativeMML: function( s )
            {
                ...
                base = q.removeChild( q.lastChild );
...
(function( h, b, d )
{
    ...
    var f = MathJax.Object.Subclass( {
        ...
        {
            var k = {testString: "() {} []"};
            k.family = {TeX: "MathJax_Size1", STIX: "STIXSizeOneSym"}[l] || l.replace( /-(Math)?/,
                "" ) + "MathJax_Size1";
            if (l === "STIX") {
                k.noStyleChar = true
            }
        ...
        testFont: function( n )
        {
            ...
            if (!p.match( /^(STIX|MathJax)|'/ )) {
                p = p.replace( /_/g, " " ).replace( /([a-z])([A-Z])/g, "$1 $2" ).replace( / Jax/,
                    "Jax" ) + "','" + p + "','" + p + "-";
                if (n.weight) {
                    p += "Bold"
                }
    ...
    d.Augment( {
        ...
        preTranslate: function( p )
        {
            ...
            for (y = 0; y < v; y++) {
                ...
                if (l.HTMLCSS.display) {
                    r = this.Element( "div", {className: "MathJax_Display"} );
                    r.appendChild( x )
                } else {
        ...
        MeasureSpans: function( o )
        {
            ...
            for (q = 0, n = o.length; q < n; q++) {
                ...
                u = t.bbox;
                s = this.parentNode( t );
                if (u.exactW || u.width || u.w === 0 || u.isMultiline || this.config.noReflows) {
                    if (!s.bbox) {
                        s.bbox = u
                    }
                    continue
        ...
        createRule: function( r, n, p, s, l )
        {
            ...
            if (s > 0 && !this.noReflows && q.offsetWidth == 0) {
        ...
        createFrame: function( s, q, r, u, x, l )
        {
            ...
            var n = this.addElement( s, "span", {
                style: {border: m, display: "inline-block", overflow: "hidden", width: o, height: v},
            ...
            if (!u.noAdjust) {
                ...
                if (this.msieInlineBlockAlignBug) {
                    ...
                    this.addElement( u, "span",
                        {isMathJax: true, style: {display: "inline-block", width: 0, height: this.Em( w )}} );
        ...
        checkFont: function( k, l )
        {
            ...
            return (k.family.replace( /'/g, "" ) === l.fontFamily.replace( /'/g,
                "" ) && (k.style || "normal") === (l.fontStyle || "normal") && (k.weight || "normal") === m)
        },
    ...
    MathJax.Hub.Register.StartupHook( "mml Jax Ready", function()
    {
        ...
        g.mspace.Augment( {
            toHTML: function( o )
            {
                ...
                var n = d.length2em( m.height, l ) * this.mscale, p = d.length2em( m.depth,
                        l ) * this.mscale, k = d.length2em( m.width, l ) * this.mscale;
        ...
        g.mpadded.Augment( {
            toHTML: function( s, m, k )
            {
                ...
                if (this.data[0] != null) {
                    ...
                    var t = this.getValues( "height", "depth", "width", "lspace",
                        "voffset" ), r = 0, p = 0, u = this.HTMLgetMu( s );
                    this.HTMLgetScale();
                    if (t.lspace) {
        ...
        g.math.Augment( {
            toHTML: function( x, n )
            {
                var q = d.addElement( x, "nobr", {isMathJax: true} );
                ...
                var v = d.createStack( x ), r = d.createBox( v ), w;
                ...
                if (!this.isMultiline && this.Get( "display" ) === "block" && x.bbox.width == null) {
                    var y = this.getValues( "indentalignfirst", "indentshiftfirst", "indentalign", "indentshift" );
                    if (y.indentalignfirst !== g.INDENTALIGN.INDENTALIGN) {
                        y.indentalign = y.indentalignfirst
                    }
                    if (y.indentalign === g.INDENTALIGN.AUTO) {
                        y.indentalign = this.displayAlign
                    }
                    if (y.indentshiftfirst !== g.INDENTSHIFT.INDENTSHIFT) {
                        y.indentshift = y.indentshiftfirst
                    }
                    if (y.indentshift === "auto") {
                        y.indentshift = "0"
                    }
                    var l = d.length2em( y.indentshift, 1, d.scale * d.cwidth );
                    if (this.displayIndent !== "0") {
                        var m = d.length2em( this.displayIndent, 1, d.scale * d.cwidth );
                        l += (y.indentalign === g.INDENTALIGN.RIGHT ? -m : m)
                    }
                    n.style.textAlign = y.indentalign;
                    if (l) {
                        l *= d.em / d.outerEm;
                        b.Insert( x.style, ({
                            left: {marginLeft: d.Em( l )},
                            right: {marginLeft: d.Em( Math.max( 0, x.bbox.w + l ) ), marginRight: d.Em( -l )},
                            center: {marginLeft: d.Em( l ), marginRight: d.Em( -l )}
                        })[y.indentalign] );
                        if (o) {
                            o.style.marginLeft = d.Em( parseFloat( o.style.marginLeft ) + l );
                            o.style.marginRight = d.Em( parseFloat( o.style.marginRight ) - l + (y.indentalign === "right" ? Math.min( 0,
                                x.bbox.w + l ) - x.bbox.w : 0) )
                        }
                    }
                }
                return x
        ...
        b.Browser.Select( {
            ...
            }, Firefox: function( l )
            {
                ...
                if (l.versionAtLeast( "3.5" )) {
                    ...
                    if (document.location.protocol !== "file:" || b.config.root.match( /^https?:\/\// ) || (b.config.root + "/").substr( 0,
                            k.length ) === k) {
                        m = "otf"
                    }
                }
...
MathJax.Hub.Register.StartupHook( "HTML-CSS Jax Ready", function()
{
    ...
    a.mtable.Augment( {
        toHTML: function( r )
        {
            ...
            var I = this.getValues( "columnalign", "rowalign", "columnspacing", "rowspacing", "columnwidth",
