...
}( jQuery ), +function( a )
{
    ...
    }, c.prototype.show = function( b )
    {
            ...
            '[data-dismiss="modal"]', a.proxy( this.hide, this ) ), this.backdrop( function()
        {
            ...
            d.$element.parent().length || d.$element.appendTo( d.$body ), d.$element.show().scrollTop( 0 ), d.options.backdrop && d.adjustBackdrop(), d.adjustDialog(), e && d.$element[0].offsetWidth, d.$element.addClass( "in" ).attr( "aria-hidden",
                !1 ), d.enforceFocus();
