...
(function(e)
{
    function m(e, t, n, r)
    {
        for (var i, s = n.slice(), o = b(t, e), u = 0, a = s.length; u < a; u++) {
            handler = s[u], typeof handler == "object" && typeof handler.handleEvent == "function" ? handler.handleEvent(o) : handler.call(e,
                o);
            if (o.stoppedImmediatePropagation) {
                break
            }
        }
    ...
    function T(e)
    {
        !n && p.test(document.readyState) && (n = !n, document.detachEvent(r,
            T), e = document.createEvent("Event"), e.initEvent(i, !0, !0), document.dispatchEvent(e))
    }

    function N(e)
    {
        var t;
        while (t = this.lastChild) {
            this.removeChild(t);
        }
    ...
    var t = !0, n = !1, r = "onreadystatechange", i = "DOMContentLoaded", s = "__IE8__" + Math.random(), o = Object.defineProperty || function(
            e,
            t,
            n
        )
        ...
        }, a = Object.getOwnPropertyDescriptor, f = Object.prototype.hasOwnProperty, l = e.Element.prototype, c = e.Text.prototype, h = /^[a-z]+$/, p = /loaded|complete/, d = {}, v = document.createElement("div");
    y(e.HTMLCommentElement.prototype, l, "nodeValue"), y(e.HTMLScriptElement.prototype, null, "text"), y(c, null,
        "nodeValue"), y(e.HTMLTitleElement.prototype, null, "text"), o(e.HTMLStyleElement.prototype, "textContent",
        function(e)
        {
            return g(function()
            {
        ...
        }(a(e.CSSStyleSheet.prototype, "cssText"))), u(l, {
        textContent: {get: E, set: N}, firstElementChild: {
            get: function()
            {
            ...
            {
                this._oninput && (this.removeEventListener("input",
                    this._oninput), this._oninput = e, e && this.addEventListener("input", e))
            }
            ...
            {
                var r = this, i = "on" + e, u = r[s] || o(r, s,
                        {value: {}})[s], a = u[i] || (u[i] = {}), l = a.h || (a.h = []), c;
                if (!f.call(a, "w")) {
                    a.w = function(e)
                    {
                        return e[s] || m(r, C(r, e), l, !1)
                    };
                    if (!f.call(d, i)) {
                        if (h.test(e)) {
                            try {
                                c = document.createEventObject(), c[s] = !0, r.nodeType != 9 && r.parentNode == null && v.appendChild(r), r.fireEvent(i,
                                    c), d[i] = !0
                            } catch (c) {
                                d[i] = !1;
                    ...
                    (a.n = d[i]) && r.attachEvent(i, a.w)
                }
                w(l, t) < 0 && l[n ? "unshift" : "push"](t), e === "input" && r.attachEvent("onkeyup", x)
            }
        }, dispatchEvent: {
            value: function(e)
            {
                var t = this, n = "on" + e.type, r = t[s], i = r && r[n], o = !!i, u;
                return e.target || (e.target = t), o ? i.n ? t.fireEvent(n, e) : m(t, e, i.h,
                    !0) : (u = t.parentNode) ? u.dispatchEvent(e) : !0, !e.defaultPrevented
            }
        }, removeEventListener: {
            value: function(e, t, n)
            {
                var r = this, i = "on" + e, o = r[s], u = o && o[i], a = u && u.h, f = a ? w(a, t) : -1;
                -1 < f && a.splice(f, 1)
            }
        }
    }), u(c, {
        addEventListener: {value: l.addEventListener},
        dispatchEvent: {value: l.dispatchEvent},
        removeEventListener: {value: l.removeEventListener}
    }), u(e.XMLHttpRequest.prototype, {
        addEventListener: {
            value: function(e, t, n)
            {
                var r = this, i = "on" + e, u = r[s] || o(r, s,
                        {value: {}})[s], a = u[i] || (u[i] = {}), f = a.h || (a.h = []);
                w(f, t) < 0 && (r[i] || (r[i] = function()
                {
                    var t = document.createEvent("Event");
            ...
            value: function(e)
            {
                ...
                return o && (i.n ? t.fireEvent(n, e) : m(t, e, i.h, !0))
            }
        }, removeEventListener: {value: l.removeEventListener}
    }), u(e.Event.prototype, {
        ...
        textContent: {
            get: function()
            {
                return this.nodeType === 11 ? E.call(this) : null
            }, set: function(e)
            {
        ...
        addEventListener: {
            ...
            {
                var u = this;
                l.addEventListener.call(u, n, s, o), t && n === i && !p.test(u.readyState) && (t = !1, u.attachEvent(r,
                    T), e == top && function a(e)
                {
                    try {
        ...
        getComputedStyle: {
            value: function()
            {
                ...
                var e = /^(?:[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|))(?!px)[a-z%]+$/, t = /^(top|right|bottom|left)$/, n = /\-([a-z])/g, r = function(
                    e,
                    t
                )
                {
                ...
                return i.prototype.getPropertyValue = function(i)
                {
                    ...
                    return i = (i === "float" ? "style-float" : i).replace(n,
                        r), f = u ? u[i] : o[i], e.test(f) && !t.test(i) && (l = o.left, c = a && a.left, c && (a.left = u.left), o.left = i === "fontSize" ? "1em" : f, f = o.pixelLeft + "px", o.left = l, c && (a.left = c)), f == null ? f : f + "" || "auto"
            ...
            value: function(t, n, r)
            {
                ...
                i[o] || (i[o] = function(e)
                {
                    return m(i, C(i, e), u, !1)
                }), u = i[o][s] || (i[o][s] = []), w(u, n) < 0 && u[r ? "unshift" : "push"](n)
            }
        }, dispatchEvent: {
            value: function(t)
            {
            ...
            value: function(t, n, r)
            {
                var i = "on" + t, o = (e[i] || Object)[s], u = o ? w(o, n) : -1;
                -1 < u && o.splice(u, 1)
            }
        }
    })
            ...
            function(_dereq_, module, exports)
            {
                ...
                common.css = function(el, property, value)
                {
                    ...
                    if (typeof value !== 'undefined') {
                        if (value === '') {
                            return el ? el.style.removeProperty(property) : undefined;
                        }
...
// Inserts `el` after `child` that is child of `par`
                ...
                common.width = function(el, val)
                {
                    /*jshint -W093 */
                    if (val) {
                        return el.style.width = ('' + val).replace(/px$/, '') + 'px';
                    }
                ...
                common.height = function(el, val)
                {
                    /*jshint -W093 */
                    if (val) {
                        return el.style.height = ('' + val).replace(/px$/, '') + 'px';
                    }
                ...
                common.hasParent = function(el, parentSelector)
                {
                    ...
                    while (parent) {
                        if (common.matches(parent, parentSelector)) {
                            return true;
                        }
                ...
                engineImpl = function flashEngine(player, root)
                {
                    ...
                    var engine = {
                        ...
                        pick: function(sources)
                        {
                            ...
                            if (flowplayer.support.flashVideo) {
                                ...
                                for (var i = 0, source; i < sources.length; i++) {
                                    source = sources[i];
                                    if (/mp4|flv|flash/i.test(source.type)) {
                                        selectedSource = source;
                                    }
                                    if (player.conf.swfHls && /mpegurl/i.test(source.type)) {
                                        selectedSource = source;
                                    }
                                    if (selectedSource && !/mp4/i.test(selectedSource.type)) {
                        ...
                        load: function(video)
                        {
                            ...
                            var html5Tag = common.findDirect('video', root)[0] || common.find('.fp-player > video',
                                        root)[0],
                            ...
                            if (!is_absolute && !rtmp) {
                                url = common.createAbsoluteUrl(url);
                            }

                            if (api && isHLS(video) && api.data !== conf.swfHls) {
                                engine.unload();
                            }
                            ...
                            if (api) {
                                ...
                                [
                                ...
                                ].forEach(function(key)
                                    {
                                        ...
                                        if ((conf.rtmp || {}).hasOwnProperty(key)) {
                                            opts[key] = (conf.rtmp || {})[key];
                                        }
                                        if ((video.rtmp || {}).hasOwnProperty(key)) {
                                            opts[key] = (video.rtmp || {})[key];
                                        }
                                    });
                                if (conf.rtmp) {
                                    opts.rtmp = conf.rtmp.url || conf.rtmp;
                                }
                                if (video.rtmp) {
                                    opts.rtmp = video.rtmp.url || video.rtmp;
                                }
                                Object.keys(video.flashls || {}).forEach(function(key)
                                {
                                ...
                                if (conf.bufferTime !== undefined) {
                                    opts.bufferTime = conf.bufferTime;
                                }
                                ...
                                api.pollInterval = setInterval(function()
                                {
                                    ...
                                    if (player.playing && status.time && status.time !== player.video.time) {
...
// HTML5 --> Flowplayer event
                    ...
                    return self = {
                        ...
                        load: function(video)
                        {
                            ...
                            if (conf.splash && !api) {
                                ...
                                if (!api) {
                                    api = createVideoTag(video, !!video.autoplay || !!conf.autoplay,
                                        conf.clip.preload || 'metadata', false);
                                    common.prepend(container, api);
                                    created = true;
                                } else {
                                    ClassList(api).add('fp-engine');
                                    common.find('source,track', api).forEach(common.removeNode);
                                    if (!player.conf.nativesubtitles) {
                            ...
                            if (conf.clip.preload != 'none' && video.type != "mpegurl" || !support.zeropreload || !support.dataload) {
                                api.load();
                            }
                            if (created || reload) {
                                api.load();
                            }
                            if (api.paused && (video.autoplay || conf.autoplay)) {
                                api.play();
                            }
                        },
                    ...
                    function listen(api, sources, video)
                    {
                            ...
                            try {
                                if (canPlay(e.target.getAttribute('type'))) {
                                    player.trigger("error",
                                        [player, {code: 4, video: extend(video, {src: api.src, url: api.src})}]);
                                }
                            } catch (er) {
                        ...
                        Object.keys(EVENTS).forEach(function(type)
                        {
                            ...
                            root.addEventListener(type, function(e)
                            {
                                ...
                                if (!e.target || !ClassList(e.target).contains('fp-engine')) {
                                    return;
                                }
                                ...
                                if (!player.ready && !/ready|error/.test(flow) || !flow || !common.find('video',
                                        root).length) {
                                    return;
                                }
                                        ...
                                        timer = timer || setInterval(function()
                                            {
                                                ...
                                                if (arg.buffer) {
                                                    if (round(arg.buffer, 1000) < round(arg.duration,
                                                            1000) && !arg.buffered) {
                ...
                flowplayer(function(player, root)
                {
                    ...
                    if (id) {
                        ...
                        if (typeof _gat == 'undefined') {
                            scriptjs("//google-analytics.com/ga.js");
                        }
                ...
                flowplayer(function(player, root)
                {
                    ...
                    player.addCuepoint = function(cue)
                    {
                        ...
                        if (player.conf.generate_cuepoints && cue.visible !== false) {
                            ...
                            var el = common.createElement('a',
                                {className: 'fp-cuepoint fp-cuepoint' + (player.cuepoints.length - 1)});
                    ...
                    function segmentForCue(cue)
                    {
                        ...
                        if (time < 0) {
                            time = player.video.duration + time;
                        }
            ...
            function(_dereq_, module, exports)
            {
                ...
                flowplayer(function(player, root)
                {
                    ...
                    player.embedCode = function()
                    {
                        ...
                        if (embedConf.playlist) {
                            props.push('playlist');
                        }
                        var c = common.pick(player.conf, props);
                        if (c.logo) {
                            c.logo = common.createElement('img', {src: c.logo}).src;
                        }
                        if (!embedConf.playlist || !player.conf.playlist.length) {
                            c.clip = extend({}, player.conf.clip,
                                common.pick(player.video, ['sources']));
                        }
                        var script = "var w=window,d=document,e;w._fpes||(w._fpes=[],w.addEventListener(\"load\",function(){var s=d.createElement(\"script\");s.src=\"//embed.flowplayer.org/6.0.3/embed.min.js\",d.body.appendChild(s)})),e=[].slice.call(d.getElementsByTagName(\"script\"),-1)[0].parentNode,w._fpes.push({e:e,l:\"$library\",c:$conf});\n".replace('$conf',
                            JSON.stringify(c)).replace('$library', embedConf.library || '');

                        return '<a href="$href">Watch video!\n<script>$script</script></a>'.replace('$href',
                            player.conf.origin || window.location.href).replace('$script', script);
                ...
                var fptip = function(root, trigger, active)
                {
                    ...
                    bean.on(root, 'click', trigger || 'a', function(e)
                    {
                        ...
                        if (rootClasses.contains(active)) {
                            ...
                            {
                                if (!common.hasParent(e.target, '.' + active)) {
                                    close();
                                }
                            });
                        }
            ...
            function(_dereq_, module, exports)
            {
                ...
                module.exports = function(obj, elem)
                {
                    ...
                    } //In this case we always want to trigger (Custom)Events on dom element
                    ...
                    obj.off = obj.unbind = function(typ)
                    {
                        ...
                        types.forEach(function(type)
                        {
                            ...
                            Object.keys(handlers).filter(function(t)
                            {
                                ...
                                return (!actualType || t.indexOf(actualType) === 0) && containsAll(handlerNamespaces,
                                        typeNameSpaces);
                            }).forEach(function(t)
                            {
...
// esc button
                bean.on(document,
                    ...
                    function(e)
                    {
                        ...
                        if (!FULL_PLAYER && (!el.parentNode || !el.parentNode.getAttribute('data-flowplayer-instance-id'))) {
                            return;
                        }
                ...
                flowplayer(function(player, root)
                {
                    ...
                    {
                        if (common.matches(el, '.fp-ratio,script')) {
                            return;
                        }
            ...
            function(_dereq_, module, exports)
            {
                ...
                if (flowplayer.support.touch || isIeMobile) {
                    ...
                    flowplayer(function(player, root)
                    {
                        ...
                        if (!flowplayer.support.inlineVideo || player.conf.native_fullscreen) {
                            player.conf.nativesubtitles = true;
                        }
            ...
            function(_dereq_, module, exports)
            {
                ...
                flowplayer(function(player, root)
                {
                    ...
                    player.play = function(i)
                    {
                        ...
                        if (i === player.video.index) {
                            return player.load(arg, function()
                            {
                                player.resume();
                            });
                        }
                    ...
                    if (conf.advance) {
                        player.off("finish.pl").on("finish.pl", function(e, player)
                        {
                            ...
                            if (next < player.conf.playlist.length || conf.loop) {
                                ...
                                setTimeout(function()
                                { // Let other finish callbacks fire first
                                    player.play(next);
                                });
                    ...
                    function generatePlaylist()
                    {
                        ...
                        if (!plEl) {
                            ...
                            if (!cntrls.length) {
                                common.insertAfter(root, common.find('video', root)[0], plEl);
                            } else {
                    ...
                    if (player.conf.playlist.length) { // playlist configured by javascript, generate playlist
                        ...
                        if (!player.conf.clip || !player.conf.clip.sources.length) {
                            player.conf.clip = player.conf.playlist[0];
                        }
                    }
                    ...
                    player.on("load", function(e, api, video)
                    {
                        ...
                        if (prev) {
                            ClassList(prev).remove(klass);
                        }
                        if (el) {
                            ClassList(el).add(klass);
                        }
                        // index
                    ...
                    p.bind("seek", function(e, api, time)
                    {
                        ...
                        (p.cuepoints || []).forEach(function(cue)
                        {
                            ...
                            if (entry && currentPoint != cue.index) {
                                ...
                                if (cue.subtitleEnd && time >= cue.time && cue.index == currentPoint + 1) {
                                    p.trigger("cuepoint",
                                        [p, cue]);
                                }
                            }
         ...
         <div class="message"><h2></h2><p></p></div>'.replace(/class="/g, 'class="fp-'));
                    ...
                    function setRatio(val)
                    {
                        ...
                        if (!support.inlineBlock) {
                            common.height(common.find('object', root)[0], common.height(root));
                        }
                    }
                    ...
                    if (!support.animation) {
                        common.html(waiting, "<p>loading &hellip;</p>");
                    }
                    ...
                    api.on("ready", function(ev, api, video)
                    {
                        ...
                        if (conf.adaptiveRatio && !isNaN(video.height / video.width)) {
                            setRatio(video.height / video.width,
                                true);
                        }
                        ...
                        if (api.engine.engineName === 'flash') {
                            timelineApi.disableAnimation(true, true);
                        } else {
                            timelineApi.disableAnimation(false);
                        }
                    ...
                    }).on("buffer", function()
                    {
                        ...
                        if (max < 1) {
                            common.css(buffer, "width", (max * 100) + "%");
                        } else {
                    ...
                    }).on("error", function(e, api, error)
                    {
                        ...
                        if (error) {
                            ...
                            common.find('h2',
                                el)[0].innerHTML = (api.engine && api.engine.engineName || 'html5') + ": " + error.message;
                            common.find('p',
                                el)[0].innerHTML = error.url || video.url || video.src || conf.errorUrls[error.code];
                    ...
                    bean.on(root, 'mousemove', '.fp-timeline', function(ev)
                    {
                        ...
                        common.css(timelineTooltip, 'left',
                            (x - common.offset(controls).left - common.width(timelineTooltip) / 2) + 'px');
                    });
                    ...
                    api.on('flashdisabled', function()
                    {
                        ...
                        root.appendChild(common.createElement('div', {className: "fp-flash-disabled"},
                    ...
                    var bc = common.css(root, 'background-color'),
                        has_bg = common.css(root,
                                'background-image') != "none" || bc && bc != "rgba(0, 0, 0, 0)" && bc != "transparent";
            ...
            function(_dereq_, module, exports)
            {
                ...
                var flowplayer = module.exports = function(fn, opts, callback)
                {
                    ...
                    if (fn.jquery) {
                        return flowplayer(fn[0], opts, callback);
                    }
                    if (typeof fn === 'string') {
                ...
                extend(flowplayer, {
                    ...
                    set: function(key, value)
                    {
                        if (typeof key === 'string') {
                            flowplayer.conf[key] = value;
                        } else {
                            extend(flowplayer.conf, key);
                        }
                    },
...
// keep track of players
                ...
                {
                    if (opts && opts.embed) {
                        opts.embed = extend({}, flowplayer.defaults.embed, opts.embed);
                    }
                    ...
                    var isRTL = (root.currentStyle && root.currentStyle.direction === 'rtl') ||
                        (window.getComputedStyle && window.getComputedStyle(root,
                            null) !== null && window.getComputedStyle(root,
                            null).getPropertyValue('direction') === 'rtl');

                    if (isRTL) {
                        rootClasses.add('is-rtl');
                    }
                        ...
                        load: function(video, callback)
                        {
                            ...
                            if (!engineImpl) {
                                return api.trigger("error",
                                    [api, {code: flowplayer.support.flashVideo ? 5 : 10}]);
                            }
                            ...
                            extend(video, engine.pick(video.sources.filter(function(source)
                            { // Filter out sources explicitely configured for some other engine
                                if (!source.engine) {
                                    return true;
                                }
                    ...
                    var selectEngine = function(clip)
                    {
                        ...
                        if (conf.engine) {
                            ...
                            if (eng && clip.sources.some(function(source)
                                {
                                    if (source.engine && source.engine !== eng.engineName) {
                                        return false;
                                    }
                        ...
                        if (conf.enginePreference) {
                            engines = flowplayer.engines.filter(function(one)
                            {
                        ...
                        }).on("load", function(e, api, video)
                        {
                            ...
                            if (conf.splash) {
                                common.find('.flowplayer.is-ready,.flowplayer.is-loading').forEach(function(el)
                                {
                                    ...
                                    if (playerId === root.getAttribute('data-flowplayer-instance-id')) {
                                        return;
                                    }
...
//Have to add fullscreen last
                ...
                flowplayer(function(e, o)
                {
                    ...
                    "file:" == location.protocol && (s = "localhost"), e.load.ed = 1, l.hostname = s, l.origin = d || location.href, d && n(o,
                        "is-embedded"), "string" == typeof p && (p = p.split(/,\s*/));
                    var f = function(e, a)
                    {
                        var n = i("a", {href: a, className: "fp-brand"});
                        n.innerHTML = e, t.find(".fp-controls", o)[0].appendChild(n)
                    };
                    if (p && "function" == typeof key_check && key_check(p, s)) {
                        if (l.logo) {
                            var c = i("a", {href: d, className: "fp-logo"});
                            l.embed && l.embed.popup && (c.target = "_blank");
                            var h = i("img", {src: l.logo});
                            c.appendChild(h), o.appendChild(c)
                        }
                        l.brand && d || l.brand && l.brand.showOnOrigin ? f(l.brand.text || l.brand,
                            d || location.href) : t.addClass(o, "no-brand")
                    } else {
                        f("flowplayer", "http://flowplayer.org");
                        var c = i("a", {href: "http://flowplayer.org"});
                        o.appendChild(c);
                        var y = i("div", {className: "fp-context-menu"},
                            '<ul><li class="copyright">&copy; 2015</li><li><a href="http://flowplayer.org">About Flowplayer</a></li><li><a href="http://flowplayer.org/license">GPL based license</a></li></ul>'), u = window.location.href.indexOf("localhost"), m = t.find(".fp-player",
                            o)[0];
                        7 !== u && (m || o).appendChild(y), e.on("pause resume finish unload ready", function(e, a)
                        {
                            ...
                            if (a.video.src) {
                                ...
                                ], i = 0; i < l.length && (n = a.video.src.indexOf("://" + l[i].reverse().join(".")), -1 === n); i++) {
                                    ;
                                }
                            }
                            if ((4 === n || 5 === n) && t.addClass(o,
                                    "no-brand"), /pause|resume/.test(e.type) && "flash" != a.engine.engineName && 4 != n && 5 != n) {
                                var d = {
                                    display: "block",
                                    position: "absolute",
                                    left: "16px",
                                ...
                                for (var s in d) {
                                    d.hasOwnProperty(s) && (c.style[s] = d[s]);
                                }
                                a.load.ed = r(c) && (7 === u || y.parentNode == o || y.parentNode == m) && !t.hasClass(o,
                                        "no-brand"), a.load.ed || a.pause()
                            } else {
                     ...
                     */
                                    ...
                                    var call = function(event, eargs)
                                        {
                                            return fn.apply(element,
                                                args ? slice.call(eargs, event ? 0 : 1).concat(args) : eargs)
                                        }
                        ...
                        , registry = (function()
                        {
                            ...
                            // `fn` returns false to break out of the loop
                                , forAll = function(element, type, original, handler, root, fn)
                                {
                                    ...
                                    if (!type || type == '*') {
                                        ...
                                        for (l = list.length; i < l; i++) {
                                            if ((all || list[i].matches(element, original, handler)) && !fn(list[i],
                                                    list, i, type)) {
                                                return
                                            }
                                        }
                                ...
                                , del = function(entry)
                                {
                                    forAll(entry.element, entry.type, null, entry.handler, entry.root,
                        ...
                        , add = function(element, events, fn, delfn)
                        {
                            return on.apply(
                                ...
                                , !isString(fn)
                                    ...
                                    : [element, fn, events, delfn].concat(arguments.length > 3 ? slice.call(arguments,
                                    5) : [])
                            )
                        }
...
// http://whattheheadsaid.com/2010/10/a-safer-object-keys-compatibility-implementation
                    ...
                    var hasAutomationEqualityBug = (function()
                    {
                        ...
                        for (var k in window) {
                            if (!blacklistedKeys['$' + k] && owns(window,
                                    k) && window[k] !== null && typeof window[k] === 'object') {
                                try {
