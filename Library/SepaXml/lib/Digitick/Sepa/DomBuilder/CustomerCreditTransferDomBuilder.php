...
class CustomerCreditTransferDomBuilder extends BaseDomBuilder
{
    ...
    public function visitTransferInformation(TransferInformationInterface $transactionInformation)
    {
        ...
        if ($transactionInformation->getCreditorReference() && strlen($transactionInformation->getCreditorReference()) > 0)
        {
        ...
        } elseif ($transactionInformation->getRemittanceInformation() && strlen($transactionInformation->getRemittanceInformation()) > 0) {
