...
!function( a, b )
{
        ...
        f.mime = a.type, (e || v.globalVars) && (f.useFileCache = !0), r( a.href, null, function( h, i, j, k, m )
        {
            if (m) {
                ...
                if (!c && o && m.lastModified && new Date( m.lastModified ).valueOf() === new Date( o ).valueOf()) {
                    return g( n,
                        a ), m.local = !0, b( null, null, i, a, m, j ), void 0
                }
            }
    ...
    v === b && (v = exports, w = c( "./tree" ), v.mode = "node"), v.Parser = function( a )
    {
        ...
        return t.prototype = new Error, t.prototype.constructor = t, this.env = a = a || {}, this.optimization = "optimization"in this.env ? this.env.optimization : 1, F = {
            ...
            parse: function( d, e, f )
            {
                ...
                if (x = y = E = B = 0, j = f && f.globalVars ? v.Parser.serializeVars( f.globalVars ) + "\n" : "", k = f && f.modifyVars ? "\n" + v.Parser.serializeVars( f.modifyVars ) : "", (j || f && f.banner) && (m = (f && f.banner ? f.banner : "") + j, F.imports.contentsIgnoredChars[a.currentFileInfo.filename] = m.length), d = d.replace( /\r\n/g,
                        ...
                        "" ) + k, F.imports.contents[a.currentFileInfo.filename] = d, C = function( b )
                    {
                        function c( b, c )
                        {
                            l = new t( {index: c || i, type: "Parse", message: b, filename: a.currentFileInfo.filename},
                                a )
                        }
                ...
                var p = function( b )
                {
                    return b = l || b || F.imports.error, b ? (b instanceof t || (b = new t( b, a )), e( b )) : e( null,
                        g )
                };
            ...
            parsers: G = {
                ...
                {
                    var b;
                    if ("/" === u.charAt( x ))return "/" === u.charAt( x + 1 ) ? new w.Comment( i( /^\/\/.*/ ), !0, x,
                        a.currentFileInfo ) : (b = i( /^\/\*(?:[^*]|\*+[^\/*])*\*+\/\n?/ ), b ? new w.Comment( b, !1, x,
                ...
                }, comments: function()
                {
                    ...
                    {
                        var b;
                        if ("u" === u.charAt( x ) && i( /^url\(/ ))return b = this.quoted() || this.variable() || i( /^(?:(?:\\[\(\)'"])|[^\(\)'"])+/ ) || "", m( ")" ), new w.URL( null != b.value || b instanceof w.Variable ? b : new w.Anonymous( b ),
                            a.currentFileInfo )
                    }, variable: function()
                    {
                        var b, c = x;
                    ...
                    }, dimension: function()
                    {
                        ...
                        if (!(b > 57 || 43 > b || 47 === b || 44 == b))return a = i( /^([+-]?\d*\.?\d+)(%|[a-z]+)?/ ), a ? new w.Dimension( a[1],
                            a[2] ) : void 0
                    ...
                    call: function()
                    {
                        ...
                        if ("." === l || "#" === l) {
                            ...
                            return c && (j( "(" ) && (k = this.args( !0 ).args, m( ")" )), G.important() && (n = !0), G.end()) ? new w.mixin.Call( c,
                                k, o, a.currentFileInfo, n ) : (e(), void 0)
                        }
                    }, args: function( a )
                    {
                    ...
                    }, definition: function()
                    {
                        ...
                        if (!("." !== u.charAt( x ) && "#" !== u.charAt( x ) || o( /^[^{]*\}/ )) && (d(), b = i( /^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/ ))) {
                            ...
                            if (g = k.args, h = k.variadic, j( ")" ) || (B = x, e()), G.comments(), i( /^when/ ) && (f = l( G.conditions,
                                    "expected condition" )), c = G.block())return new w.mixin.Definition( a, g, c, f,
                                h );
                            e()
                        }
                    }
                ...
                }, selector: function( b )
                {
                    ...
                    return c ? new w.Selector( c, d, i, j,
                        a.currentFileInfo ) : (d && n( "Extend must be used to extend a selector, it cannot be used on its own" ), void 0)
                }, attribute: function()
                {
                    if (j( "[" )) {
                ...
                }, "import": function()
                {
                    ...
                    return g && (b = this.entities.quoted() || this.entities.url()) && (c = this.mediaFeatures(), j( ";" )) ? (c = c && new w.Value( c ), new w.Import( b,
                        c, h, f, a.currentFileInfo )) : (e(), void 0)
                ...
                }, media: function()
                {
                    ...
                    return a.dumpLineNumbers && (e = s( x, u,
                        a )), i( /^@media/ ) && (b = this.mediaFeatures(), c = this.block()) ? (d = new w.Media( c, b,
                        x, a.currentFileInfo ), a.dumpLineNumbers && (d.debugInfo = e), d) : void 0
                }, directive: function()
                {
                ...
                }, multiplication: function()
                {
                    ...
                    if (a = this.operand()) {
                        for (e = g( u, x - 1 ); ;) {
                            ...
                            a.parensInOp = !0, b.parensInOp = !0, d = new w.Operation( c, [d || a, b], e ), e = g( u,
                                x - 1 )
                        }
                        return d || a
                    }
        ...
        a.JavaScript = function( a, b, c )
        {
            ...
            type: "JavaScript", eval: function( b )
            {
                ...
                return "number" == typeof c ? new a.Dimension( c ) : "string" == typeof c ? new a.Quoted( '"' + c + '"',
                    c, this.escaped,
                    this.index ) : Array.isArray( c ) ? new a.Anonymous( c.join( ", " ) ) : new a.Anonymous( c )
            }
        }
    }( c( "../tree" ) ), function( a )
    {
    ...
    }( c( "../tree" ) ), function( a )
    {
            ...
            }, eval: function( b )
            {
                ...
                for (e = this.arguments && this.arguments.map( function( a )
                {
                    ...
                    for (g = 0; g < q.length; g++)if (l = q[g].group, l === t || l === m)try {
                        d = q[g].mixin, d instanceof a.mixin.Definition || (d = new a.mixin.Definition( "", [], d.rules,
                            null,
        ...
        }, a.mixin.Definition = function( b, c, d, e, f )
        {
            ...
            {
                var e, f, g = [], h = this.frames.concat( b.frames ), i = this.evalParams( b, new a.evalEnv( b, h ), c,
                    g );
                    ...
                    if (d && (!d.css || f)) {
                        ...
                        b.options.multiple && (h.importMultiple = !0), this._importer.push( b.getPath(),
                            b.currentFileInfo, b.options, function( c, d, g, i )
                            {
                                ...
                                return !d || (b.root = d, b.importedFilename = i, f || b.skip) ? (j(), void 0) : (new a.importVisitor( e._importer,
                                    j, h ).run( d ), void 0)
                            } )
                    }
                }
