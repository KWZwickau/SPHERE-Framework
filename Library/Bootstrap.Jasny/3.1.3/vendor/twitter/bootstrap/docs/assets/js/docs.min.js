...
function AnchorJS( a )
{
    ...
    }, this._applyRemainingDefaultOptions( a ), this.add = function( a )
    {
        ...
        for (this._addBaselineStyles(), c = document.querySelectorAll( "[id]" ), d = [].map.call( c, function( a )
        {
            ...
            if (b[f].hasAttribute( "id" )) {
                ...
                g = b[f].textContent, h = g.replace( /[^\w\s-]/gi, "" ).replace( /\s+/g, "-" ).replace( /-{2,}/g,
                    "-" ).substring( 0, 32 ).replace( /^-+|-+$/gm, "" ).toLowerCase(), k = h, j = 0;
                do {
            ...
            l = e.replace( /-/g,
                " " ), m = '<a class="anchorjs-link ' + this.options["class"] + '" href="#' + e + '" aria-label="Anchor link for: ' + l + '" data-anchorjs-icon="' + this.options.icon + '"></a>', n = document.createElement( "div" ), n.innerHTML = m, o = n.childNodes, "always" === this.options.visible && (o[0].style.opacity = "1"), "&#xe9cb" === this.options.icon && (o[0].style.fontFamily = "anchorjs-icons", o[0].style.fontStyle = "normal", o[0].style.fontVariant = "normal", o[0].style.fontWeight = "normal"), "left" === this.options.placement ? (o[0].style.position = "absolute", o[0].style.marginLeft = "-1em", o[0].style.paddingRight = "0.5em", b[f].insertBefore( o[0],
                b[f].firstChild )) : (o[0].style.paddingLeft = "0.375em", b[f].appendChild( o[0] ))
        }
        return this
    ...
    }, this._addBaselineStyles = function()
    {
        if (null === document.head.querySelector( "style.anchorjs" )) {
            ...
            b.className = "anchorjs", b.appendChild( document.createTextNode( "" ) ), a = document.head.querySelector( '[rel="stylesheet"], style' ), void 0 === a ? document.head.appendChild( b ) : document.head.insertBefore( b,
                a ), b.sheet.insertRule( c, b.sheet.cssRules.length ), b.sheet.insertRule( d,
                b.sheet.cssRules.length ), b.sheet.insertRule( f, b.sheet.cssRules.length ), b.sheet.insertRule( e,
                b.sheet.cssRules.length )
        }
    }
}
!function( a, b )
        ...
        function( a, b, c )
        {
            (function( b )
            {
                ...
                function f( a )
                {
                    ...
                    d.theme = h, c.holderData = {flags: d, engineSettings: o}, ("image" == b || "fluid" == b) && p( c,
                ...
                function g( a )
                {
                    ...
                    "background" == e ? (g.style.backgroundImage = "url(" + d + ")", g.style.backgroundSize = j.width + "px " + j.height + "px") : ("img" === g.nodeName.toLowerCase() ? p( g,
                        {src: d} ) : "object" === g.nodeName.toLowerCase() && (p( g, {data: d} ), p( g,
                        {type: "image/svg+xml"} )), i.reRender && b.setTimeout( function()
                    {
                        var a = c();
                        if (null == a) {
                            throw"Holder: couldn't render placeholder";
                        ...
                        "img" === g.nodeName.toLowerCase() ? p( g,
                            {src: a} ) : "object" === g.nodeName.toLowerCase() && (p( g, {data: a} ), p( g,
                            {type: "image/svg+xml"} ))
                ...
                function h( a )
                {
                    function b( a, b, c, d )
                    {
                        b.width = c, b.height = d, a.width = Math.max( a.width,
                            b.width ), a.height += b.height, a.add( b )
                    }
                    ...
                    var d = new w( {width: a.width, height: a.height} ), e = d.Shape, f = new e.Rect( "holderBg",
                    ...
                    if (h.lineCount > 1) {
                        ...
                        for (var p = 0; p < h.words.length; p++) {
                            ...
                            j = new e.Text( q.text );
                            var r = "\\n" == q.text;
                            (l + q.width >= n || r === !0) && (b( g, k, l,
                                g.properties.leading ), l = 0, m += g.properties.leading, o += 1, k = new e.Group( "line" + o ), k.y = m), r !== !0 && (j.moveTo( l,
                                0 ), l += h.spaceWidth + q.width, k.add( j ))
                        }
                        b( g, k, l, g.properties.leading );
                        for (var s in g.children) {
                            k = g.children[s], k.moveTo( (g.width - k.width) / 2, null, null );
                        }
                        g.moveTo( (a.width - g.width) / 2, (a.height - g.height) / 2,
                            null ), (a.height - g.height) / 2 < 0 && g.moveTo( null, 0, null )
                    } else {
                        j = new e.Text( a.text ), k = new e.Group( "line0" ), k.add( j ), g.add( k ), g.moveTo( (a.width - h.boundingBox.width) / 2,
                ...
                function i( a, b, c )
                {
                    var d = parseInt( a, 10 ), e = parseInt( b, 10 ), f = Math.max( d, e ), g = Math.min( d,
                        e ), h = .8 * Math.min( g, f * K.defaults.scale );
                ...
                function r( a, c )
                {
                    if (b.XMLSerializer) {
                        ...
                        if (c.svgXMLStylesheet) {
                            ...
                            var j = g.createProcessingInstruction( "xml",
                                'version="1.0" encoding="UTF-8" standalone="yes"' );
                            g.insertBefore( j,
                                g.firstChild ), g.removeChild( g.documentElement ), e = d.serializeToString( g )
                        }
                ...
                var v = c( 1 ), w = c( 2 ), x = c( 3 ), y = x.extend, z = x.cssProps, A = x.encodeHtmlEntity, B = x.decodeHtmlEntity, C = x.imageExists, D = x.getNodeArray, E = x.dimensionCheck, F = "http://www.w3.org/2000/svg", G = 8, H = "2.6.0", I = "\nCreated with Holder.js " + H + ".\nLearn more at http://holderjs.com\n(c) 2012-2015 Ivan Malopinsky - http://imsky.co\n", J = {
                    ...
                    run: function( a )
                    {
                        ...
                        for (l = 0; l < h.length; l++) {
                            ...
                            J ? 0 === I.src.indexOf( g.domain ) ? d( g, c, I.src, H ) : L && (M ? d( g, c, I.dataSrc,
                ...
                }, L = function()
                {
                    ...
                    return function( d )
                    {
                        ...
                        if (K.setup.supportsSVG) {
                            ...
                            (null == a || a.parentNode !== document.body) && (f = !0), a = q( a, e.properties.width,
                                e.properties.height ), a.style.display = "block", f && (b = o( "text",
                                F ), c = g( null ), p( b,
                            ...
                            var n = b.getComputedTextLength(), r = j.width - n, s = Math.round( r / Math.max( 1,
                                l.length - 1 ) ), t = [];
                            if (k > 1) {
                                c.nodeValue = "";
                ...
                }(), M = function()
                {
                    ...
                    return function( c )
                    {
                        ...
                        var d = c.root;
                        a.width = K.dpr( d.properties.width ), a.height = K.dpr( d.properties.height ), b.textBaseline = "middle", b.fillStyle = d.children.holderBg.properties.fill, b.fillRect( 0,
                            0, K.dpr( d.children.holderBg.width ), K.dpr( d.children.holderBg.height ) );
                ...
                }(), N = function()
                {
                    if (b.XMLSerializer) {
                        ...
                        return c.appendChild( d ), function( b, e )
                        {
                            ...
                            var i = e.holderSettings.flags.holderURL, j = "holder_" + (Number( new Date ) + 32768 + (0 | 32768 * Math.random())).toString( 16 ), k = o( "g",
                                F ), l = f.children.holderTextGroup, m = l.properties, n = o( "g",
                                F ), s = l.textPositionData, t = "#" + j + " text { " + z( {
                                    fill: m.fill,
                            ...
                            p( k, {id: j} ), c.insertBefore( u,
                                c.firstChild ), w.appendChild( v ), k.appendChild( d ), k.appendChild( n ), c.appendChild( k ), p( d,
                                {
                            ...
                            for (var x in l.children) {
                                ...
                                for (var A in y.children) {
                                    var B = y.children[A], C = l.x + y.x + B.x, D = l.y + y.y + B.y, E = o( "text",
                                        F ), G = document.createTextNode( null );
                                    p( E, {
                                        x: C,
                                        y: D
                            ...
                            var H = "data:image/svg+xml;base64," + btoa( unescape( encodeURIComponent( r( c,
                                    e.engineSettings ) ) ) );
                            return H
                        }
                    }
                ...
                }, function()
                {
                    ...
                    d.getContext && -1 != d.toDataURL( "image/png" ).indexOf( "data:image/png" ) && (K.setup.renderer = "canvas", e = d.getContext( "2d" ), K.setup.supportsCanvas = !0), K.setup.supportsCanvas && (a = b.devicePixelRatio || 1, c = e.webkitBackingStorePixelRatio || e.mozBackingStorePixelRatio || e.msBackingStorePixelRatio || e.oBackingStorePixelRatio || e.backingStorePixelRatio || 1), K.setup.ratio = a / c, document.createElementNS && document.createElementNS( F,
                        "svg" ).createSVGRect && (K.setup.renderer = "svg", K.setup.supportsSVG = !0)
                }(), m(), v && v( function()
                {
                    K.vars.preempted || J.run(), b.addEventListener ? (b.addEventListener( "resize", u,
                        !1 ), b.addEventListener( "orientationchange", u, !1 )) : b.attachEvent( "onresize",
                        u ), "object" == typeof b.Turbolinks && b.document.addEventListener( "page:change", function()
                    {
                        J.run()
                    } )
                } ), a.exports = J
...
!function( a )
{
    ...
    a( function()
    {
        ...
        d.on( "load", function()
        {
            e.data( "placement", "top" ).attr( "title", "Copy to clipboard" ).tooltip(), d.on( "dataRequested",
                function( b )
                {
