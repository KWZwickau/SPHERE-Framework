(function( a )
{
    ...
    function W( b )
    {
        ...
        for (e = O( b._f, b._locale ).match( Nb ) || [], c = 0; c < e.length; c++) {
            f = e[c], d = (h.match( P( f, b ) ) || [])[0], d && (g = h.substr( 0,
    ...
    pc.DDDD = h( pc.DDD, 3 ), m( j.prototype, {
        ...
        weekdaysParse: function( a )
        {
            ...
            for (this._weekdaysParse || (this._weekdaysParse = []), b = 0; 7 > b; b++) {
                if (this._weekdaysParse[b] || (c = tb( [2000, 1] ).day( b ), d = "^" + this.weekdays( c,
    ...
    }( function( a )
    {
        ...
        function c( a, c, d )
        {
            ...
            return "m" === d ? c ? "хвилина" : "хвилину" : "h" === d ? c ? "година" : "годину" : a + " " + b( e[d],
                +a );
        }
