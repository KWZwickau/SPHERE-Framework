...
exports.isValid = {
    ...
    'h/hh with hour > 12': function( test )
    {
        ...
        test.ok( moment( '06/20/2014 23:51 PM', 'MM/DD/YYYY hh:mm A' ).parsingFlags().bigHour,
            'non-strict bigHour 23 for hh' );
        test.ok( !moment( '06/20/2014 23:51 PM', 'MM/DD/YYYY hh:mm A', true ).isValid(), 'validity 23 for hh' );
        test.ok( moment( '06/20/2014 23:51 PM', 'MM/DD/YYYY hh:mm A', true ).parsingFlags().bigHour,
            'bigHour 23 for hh' );
        test.done();
    },
    ...
    'string nonsensical with format': function( test )
    {
        ...
        test.equal( moment( 'xx-xx-2001', 'DD-MM-YYY' ).isValid(), true,
    ...
    'string with spaceless format': function( test )
    {
        ...
        test.equal( moment( '10Sep2001', 'DDMMMYYYY' ).isValid(), true,
