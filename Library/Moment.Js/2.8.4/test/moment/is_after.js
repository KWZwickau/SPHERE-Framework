...
exports.isAfter = {
    ...
    'is after year': function( test )
    {
        ...
        test.equal( m.isAfter( moment( new Date( 2011, 11, 31, 23, 59, 59, 999 ) ), 'year' ), false,
            'exact end of year' );
        test.equal( m.isAfter( moment( new Date( 2012, 0, 1, 0, 0, 0, 0 ) ), 'year' ), false, 'start of next year' );
        test.equal( m.isAfter( moment( new Date( 2010, 11, 31, 23, 59, 59, 999 ) ), 'year' ), true,
            'end of previous year' );
        test.equal( m.isAfter( moment( new Date( 1980, 11, 31, 23, 59, 59, 999 ) ), 'year' ), true,
    ...
    'is after month': function( test )
    {
        ...
        test.equal( m.isAfter( moment( new Date( 2011, 2, 31, 23, 59, 59, 999 ) ), 'month' ), false,
            'exact end of month' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 1, 0, 0, 0, 0 ) ), 'month' ), false, 'start of next month' );
        test.equal( m.isAfter( moment( new Date( 2011, 1, 27, 23, 59, 59, 999 ) ), 'month' ), true,
            'end of previous month' );
        test.equal( m.isAfter( moment( new Date( 2010, 12, 31, 23, 59, 59, 999 ) ), 'month' ), true,
    ...
    'is after day': function( test )
    {
        ...
        test.equal( m.isAfter( moment( new Date( 2011, 3, 1, 23, 59, 59, 999 ) ), 'day' ), true,
            'end of previous day' );
        test.equal( m.isAfter( moment( new Date( 2010, 3, 10, 0, 0, 0, 0 ) ), 'day' ), true,
    ...
    'is after hour': function( test )
    {
        ...
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 2, 59, 59, 999 ) ), 'hour' ), true,
    ...
    'is after minute': function( test )
    {
        ...
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 0, 0 ) ), 'minute' ), false,
            'exact start of minute' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 59, 999 ) ), 'minute' ), false,
            'exact end of minute' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 5, 0, 0 ) ), 'minute' ), false,
            'start of next minute' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 3, 59, 999 ) ), 'minute' ), true,
    ...
    'is after second': function( test )
    {
        ...
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 5, 0 ) ), 'second' ), false,
            'exact start of second' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 5, 999 ) ), 'second' ), false,
            'exact end of second' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 6, 0 ) ), 'second' ), false,
            'start of next second' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 4, 999 ) ), 'second' ), true,
    ...
    'is after millisecond': function( test )
    {
        ...
        var m = moment( new Date( 2011, 3, 2, 3, 4, 5, 10 ) ), mCopy = moment( m );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false,
            'millisecond match' );
        test.equal( m.isAfter( moment( new Date( 2010, 3, 2, 3, 4, 5, 10 ) ), 'milliseconds' ), true,
            'plural should work' );
        test.equal( m.isAfter( moment( new Date( 2012, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false, 'year is later' );
        test.equal( m.isAfter( moment( new Date( 2010, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), true,
            'year is earlier' );
        test.equal( m.isAfter( moment( new Date( 2011, 4, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false,
            'month is later' );
        test.equal( m.isAfter( moment( new Date( 2011, 2, 2, 3, 4, 5, 10 ) ), 'millisecond' ), true,
            'month is earlier' );
        ...
        test.equal( m.isAfter( moment( new Date( 2011, 3, 1, 4, 1, 5, 10 ) ), 'millisecond' ), true,
            'hour is earlier' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 5, 5, 10 ) ), 'millisecond' ), false,
            'minute is later' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 3, 5, 10 ) ), 'millisecond' ), true,
            'minute is earlier' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 6, 10 ) ), 'millisecond' ), false,
            'second is later' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 4, 5 ) ), 'millisecond' ), true,
            'second is earlier' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 6, 11 ) ), 'millisecond' ), false,
            'millisecond is later' );
        test.equal( m.isAfter( moment( new Date( 2011, 3, 2, 3, 4, 4, 9 ) ), 'millisecond' ), true,
