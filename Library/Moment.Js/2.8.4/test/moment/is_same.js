...
exports.isSame = {
    ...
    'is same year': function( test )
    {
        ...
        test.equal( m.isSame( moment( new Date( 2011, 11, 31, 23, 59, 59, 999 ) ), 'year' ), true,
            'exact end of year' );
        test.equal( m.isSame( moment( new Date( 2012, 0, 1, 0, 0, 0, 0 ) ), 'year' ), false, 'start of next year' );
        test.equal( m.isSame( moment( new Date( 2010, 11, 31, 23, 59, 59, 999 ) ), 'year' ), false,
    ...
    'is same month': function( test )
    {
        ...
        test.equal( m.isSame( moment( new Date( 2011, 2, 31, 23, 59, 59, 999 ) ), 'month' ), true,
            'exact end of month' );
        test.equal( m.isSame( moment( new Date( 2011, 3, 1, 0, 0, 0, 0 ) ), 'month' ), false, 'start of next month' );
        test.equal( m.isSame( moment( new Date( 2011, 1, 27, 23, 59, 59, 999 ) ), 'month' ), false,
    ...
    'is same day': function( test )
    {
        ...
        test.equal( m.isSame( moment( new Date( 2011, 1, 1, 23, 59, 59, 999 ) ), 'day' ), false,
            'end of previous day' );
    ...
    'is same hour': function( test )
    {
        ...
        test.equal( m.isSame( moment( new Date( 2011, 1, 2, 2, 59, 59, 999 ) ), 'hour' ), false,
    ...
    'is same minute': function( test )
    {
        ...
        test.equal( m.isSame( moment( new Date( 2011, 1, 2, 3, 4, 59, 999 ) ), 'minute' ), true,
            'exact end of minute' );
        test.equal( m.isSame( moment( new Date( 2011, 1, 2, 3, 5, 0, 0 ) ), 'minute' ), false, 'start of next minute' );
        test.equal( m.isSame( moment( new Date( 2011, 1, 2, 3, 3, 59, 999 ) ), 'minute' ), false,
    ...
    'is same second': function( test )
    {
        ...
        test.equal( m.isSame( moment( new Date( 2011, 1, 2, 3, 4, 4, 999 ) ), 'second' ), false,
    ...
    'is same millisecond': function( test )
    {
        ...
        var m = moment( new Date( 2011, 3, 2, 3, 4, 5, 10 ) ), mCopy = moment( m );
        test.equal( m.isSame( moment( new Date( 2011, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), true,
            'millisecond match' );
        test.equal( m.isSame( moment( new Date( 2011, 3, 2, 3, 4, 5, 10 ) ), 'milliseconds' ), true,
            'plural should work' );
        test.equal( m.isSame( moment( new Date( 2012, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false, 'year is later' );
        test.equal( m.isSame( moment( new Date( 2010, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false,
            'year is earlier' );
        test.equal( m.isSame( moment( new Date( 2011, 4, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false, 'month is later' );
        test.equal( m.isSame( moment( new Date( 2011, 2, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false,
            'month is earlier' );
        ...
        test.equal( m.isSame( moment( new Date( 2011, 3, 1, 4, 1, 5, 10 ) ), 'millisecond' ), false,
            'hour is earlier' );
        test.equal( m.isSame( moment( new Date( 2011, 3, 2, 3, 5, 5, 10 ) ), 'millisecond' ), false,
            'minute is later' );
        test.equal( m.isSame( moment( new Date( 2011, 3, 2, 3, 3, 5, 10 ) ), 'millisecond' ), false,
            'minute is earlier' );
        test.equal( m.isSame( moment( new Date( 2011, 3, 2, 3, 4, 6, 10 ) ), 'millisecond' ), false,
            'second is later' );
        test.equal( m.isSame( moment( new Date( 2011, 3, 2, 3, 4, 4, 5 ) ), 'millisecond' ), false,
            'second is earlier' );
        test.equal( m.isSame( moment( new Date( 2011, 3, 2, 3, 4, 6, 11 ) ), 'millisecond' ), false,
            'millisecond is later' );
        test.equal( m.isSame( moment( new Date( 2011, 3, 2, 3, 4, 4, 9 ) ), 'millisecond' ), false,
    ...
    {
        test.expect( 3 );
        test.ok( moment.parseZone( '2013-02-01T-05:00' ).isSame( moment( '2013-02-01' ), 'year' ),
            'zoned vs local moment' );
        test.ok( moment( '2013-02-01' ).isSame( moment( '2013-02-01' ).zone( '-05:00' ), 'year' ),
