...
exports.isBefore = {
    ...
    'is before year': function( test )
    {
        ...
        test.equal( m.isBefore( moment( new Date( 2011, 11, 31, 23, 59, 59, 999 ) ), 'year' ), false,
            'exact end of year' );
        test.equal( m.isBefore( moment( new Date( 2012, 0, 1, 0, 0, 0, 0 ) ), 'year' ), true, 'start of next year' );
        test.equal( m.isBefore( moment( new Date( 2010, 11, 31, 23, 59, 59, 999 ) ), 'year' ), false,
            'end of previous year' );
        test.equal( m.isBefore( moment( new Date( 1980, 11, 31, 23, 59, 59, 999 ) ), 'year' ), false,
    ...
    'is before month': function( test )
    {
        ...
        test.equal( m.isBefore( moment( new Date( 2011, 2, 1, 0, 0, 0, 0 ) ), 'month' ), false,
            'exact start of month' );
        test.equal( m.isBefore( moment( new Date( 2011, 2, 31, 23, 59, 59, 999 ) ), 'month' ), false,
            'exact end of month' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 1, 0, 0, 0, 0 ) ), 'month' ), true, 'start of next month' );
        test.equal( m.isBefore( moment( new Date( 2011, 1, 27, 23, 59, 59, 999 ) ), 'month' ), false,
            'end of previous month' );
        test.equal( m.isBefore( moment( new Date( 2010, 12, 31, 23, 59, 59, 999 ) ), 'month' ), false,
    ...
    'is before day': function( test )
    {
        ...
        test.equal( m.isBefore( moment( new Date( 2011, 3, 1, 23, 59, 59, 999 ) ), 'day' ), false,
            'end of previous day' );
        test.equal( m.isBefore( moment( new Date( 2010, 3, 10, 0, 0, 0, 0 ) ), 'day' ), false,
    ...
    'is before hour': function( test )
    {
        ...
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 59, 59, 999 ) ), 'hour' ), false,
            'exact end of hour' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 4, 0, 0, 0 ) ), 'hour' ), true, 'start of next hour' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 2, 59, 59, 999 ) ), 'hour' ), false,
    ...
    'is before minute': function( test )
    {
        ...
        test.equal( m.isBefore( moment( new Date( 2012, 3, 2, 3, 4, 9, 10 ) ), 'minutes' ), true,
            'plural should work' );
        ...
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 0, 0 ) ), 'minute' ), false,
            'exact start of minute' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 59, 999 ) ), 'minute' ), false,
            'exact end of minute' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 5, 0, 0 ) ), 'minute' ), true,
            'start of next minute' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 3, 59, 999 ) ), 'minute' ), false,
    ...
    'is before second': function( test )
    {
        ...
        test.equal( m.isBefore( moment( new Date( 2012, 3, 2, 3, 4, 5, 10 ) ), 'seconds' ), true,
            'plural should work' );
        ...
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 5, 0 ) ), 'second' ), false,
            'exact start of second' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 5, 999 ) ), 'second' ), false,
            'exact end of second' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 6, 0 ) ), 'second' ), true,
            'start of next second' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 4, 999 ) ), 'second' ), false,
    ...
    'is before millisecond': function( test )
    {
        ...
        var m = moment( new Date( 2011, 3, 2, 3, 4, 5, 10 ) ), mCopy = moment( m );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false,
            'millisecond match' );
        test.equal( m.isBefore( moment( new Date( 2010, 3, 2, 3, 4, 5, 10 ) ), 'milliseconds' ), false,
            'plural should work' );
        test.equal( m.isBefore( moment( new Date( 2012, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), true, 'year is later' );
        test.equal( m.isBefore( moment( new Date( 2010, 3, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false,
            'year is earlier' );
        test.equal( m.isBefore( moment( new Date( 2011, 4, 2, 3, 4, 5, 10 ) ), 'millisecond' ), true,
            'month is later' );
        test.equal( m.isBefore( moment( new Date( 2011, 2, 2, 3, 4, 5, 10 ) ), 'millisecond' ), false,
            'month is earlier' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 3, 3, 4, 5, 10 ) ), 'millisecond' ), true, 'day is later' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 1, 1, 4, 5, 10 ) ), 'millisecond' ), false,
            'day is earlier' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 4, 4, 5, 10 ) ), 'millisecond' ), true, 'hour is later' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 1, 4, 1, 5, 10 ) ), 'millisecond' ), false,
            'hour is earlier' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 5, 5, 10 ) ), 'millisecond' ), true,
            'minute is later' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 3, 5, 10 ) ), 'millisecond' ), false,
            'minute is earlier' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 6, 10 ) ), 'millisecond' ), true,
            'second is later' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 4, 5 ) ), 'millisecond' ), false,
            'second is earlier' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 6, 11 ) ), 'millisecond' ), true,
            'millisecond is later' );
        test.equal( m.isBefore( moment( new Date( 2011, 3, 2, 3, 4, 4, 9 ) ), 'millisecond' ), false,
