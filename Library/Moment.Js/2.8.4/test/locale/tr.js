...
exports['locale:tr'] = {
    ...
    'from': function( test )
    {
        ...
        test.equal( start.from( moment( [2007, 1, 28] ).add( {s: 44} ), true ), 'birkaç saniye',
        ...
        test.equal( start.from( moment( [2007, 1, 28] ).add( {m: 44} ), true ), '44 dakika',
    ...
    'calendar next week': function( test )
    {
        ...
        for (i = 2; i < 7; i++) {
            ...
            test.equal( m.calendar(), m.format( '[haftaya] dddd [saat] LT' ),
    ...
    'calendar last week': function( test )
    {
        ...
        for (i = 2; i < 7; i++) {
            ...
            test.equal( m.calendar(), m.format( '[geçen hafta] dddd [saat] LT' ),
