...
exports['locale:hy-am'] = {
    ...
    'format month case with escaped symbols': function( test )
    {
        ...
        for (i = 0; i < 12; i++) {
            ...
            test.equal( moment( [2013, i, 1] ).format( 'D[-ին օրը] MMMM' ), '1-ին օրը ' + months.accusative[i],
    ...
    'format month short case with escaped symbols': function( test )
    {
        ...
        for (i = 0; i < 12; i++) {
            ...
            test.equal( moment( [2013, i, 1] ).format( 'D[-ին օրը] MMM' ), '1-ին օրը ' + monthsShort.accusative[i],
    ...
    'from': function( test )
    {
        ...
        test.equal( start.from( moment( [2007, 1, 28] ).add( {s: 44} ), true ), 'մի քանի վայրկյան',
            '44 seconds = seconds' );
