...
exports['locale:nl'] = {
    ...
    'from': function( test )
    {
        ...
        test.equal( start.from( moment( [2007, 1, 28] ).add( {s: 44} ), true ), 'een paar seconden',
    ...
    'calendar last week': function( test )
    {
        ...
        for (i = 2; i < 7; i++) {
            ...
            m.hours( 0 ).minutes( 0 ).seconds( 0 ).milliseconds( 0 );
            test.equal( m.calendar(), m.format( '[afgelopen] dddd [om] LT' ),
    ...
    {
        test.equal( moment( [2012, 5, 23] ).format( 'D-MMM-YYYY' ), '23-jun-2012',
