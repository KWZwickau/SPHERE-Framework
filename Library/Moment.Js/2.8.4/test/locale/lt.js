...
exports['locale:lt'] = {
    ...
    'from': function( test )
    {
        ...
        test.equal( start.from( moment( [2007, 1, 28] ).add( {s: 44} ), true ), 'kelios sekundės',
            '44 seconds = seconds' );
        ...
        test.equal( start.from( moment( [2007, 1, 28] ).add( {m: 10} ), true ), '10 minučių',
            '10 minutes = 10 minutes' );
        test.equal( start.from( moment( [2007, 1, 28] ).add( {m: 11} ), true ), '11 minučių',
            '11 minutes = 11 minutes' );
        test.equal( start.from( moment( [2007, 1, 28] ).add( {m: 19} ), true ), '19 minučių',
            '19 minutes = 19 minutes' );
        test.equal( start.from( moment( [2007, 1, 28] ).add( {m: 20} ), true ), '20 minučių',
            '20 minutes = 20 minutes' );
        test.equal( start.from( moment( [2007, 1, 28] ).add( {m: 44} ), true ), '44 minutės',
