...
exports['locale:uz'] = {
    ...
    'from': function( test )
    {
        ...
        test.equal( start.from( moment( [2007, 1, 28] ).add( {s: 45} ), true ), 'бир дакика',
            '45 секунд = бир дакика' );
        test.equal( start.from( moment( [2007, 1, 28] ).add( {s: 89} ), true ), 'бир дакика',
    ...
    'calendar next week': function( test )
    {
        ...
        for (i = 2; i < 7; i++) {
            ...
            test.equal( m.calendar(), m.format( 'dddd [куни соат] LT [да]' ),
    ...
    'calendar last week': function( test )
    {
        ...
        for (i = 2; i < 7; i++) {
            ...
            test.equal( m.calendar(), m.format( '[Утган] dddd [куни соат] LT [да]' ),
