...
exports['locale:ms-my'] = {
    ...
    'from': function( test )
    {
        ...
        test.equal( start.from( moment( [2007, 1, 28] ).add( {s: 44} ), true ), 'beberapa saat',
    ...
    {
        test.equal( moment().fromNow(), 'beberapa saat yang lepas',
    ...
    'calendar day': function( test )
    {
        ...
        test.equal( moment( a ).subtract( {d: 1} ).calendar(), 'Kelmarin pukul 02.00',
    ...
    'calendar last week': function( test )
    {
        ...
        for (i = 2; i < 7; i++) {
            ...
            test.equal( m.calendar(), m.format( 'dddd [lepas] [pukul] LT' ),
