(function()
{
    ...
    var e = window.nv || {};
    e.version = "1.1.13b", e.dev = !0, window.nv = e, e.tooltip = {}, e.utils = e.utils || {}, e.models = {}, e.charts = {}, e.graphs = [], e.logs = {}, e.dispatch = d3.dispatch("render_start",
    ...
    }, e.render = function(n)
    {
        n = n || 1, e.render.active = !0, e.dispatch.render_start(), setTimeout(function()
        {
            ...
            e.render.queue.splice(0, i), e.render.queue.length ? setTimeout(arguments.callee,
                0) : (e.render.active = !1, e.dispatch.render_end())
        }, 0)
                ...
                switch (t.orient()) {
                    case"top":
                        ...
                        if (u) {
                            ...
                            x.enter().append("g").attr("class",
                                "nv-axisMaxMin").append("text"), x.exit().remove(), x.attr("transform", function(e, t)
                            {
                                return "translate(" + s(e) + ",0)"
                            }).select("text").attr("dy", "0em").attr("y", -t.tickPadding()).attr("text-anchor",
                                "middle").text(function(e, t)
                            {
                                var n = w(e);
                    ...
                    case"bottom":
                        ...
                        if (u) {
                            ...
                            }).select("text").attr("dy", ".71em").attr("y", t.tickPadding()).attr("transform",
                                function(e, t, n)
                                {
                                    return "rotate(" + f + " 0,0)"
                    ...
                    case"right":
                        E.enter().append("text").attr("class", "nv-axislabel"), E.style("text-anchor",
                            ...
                            l ? -Math.max(n.right, r) + 12 : -10).attr("x", l ? s.range()[0] / 2 : t.tickPadding());
                        if (u) {
                            var x = m.selectAll("g.nv-axisMaxMin").data(s.domain());
                    ...
                    case"left":
                        E.enter().append("text").attr("class", "nv-axislabel"), E.style("text-anchor",
                            ...
                            l ? -Math.max(n.left, r) + d : -10).attr("x", l ? -s.range()[0] / 2 : -t.tickPadding());
                        if (u) {
                            var x = m.selectAll("g.nv-axisMaxMin").data(s.domain());
                            x.enter().append("g").attr("class", "nv-axisMaxMin").append("text").style("opacity",
                                0), x.exit().remove(), x.attr("transform", function(e, t)
        ...
        function m(e)
        {
            return e.each(function(e, n)
            {
                var p = c - t.left - t.right, m = h - t.top - t.bottom, g = d3.select(this), y = i.call(this, e,
                    n).slice().sort(d3.descending), b = s.call(this, e, n).slice().sort(d3.descending), w = o.call(this,
                    e, n).slice().sort(d3.descending), E = u.call(this, e, n).slice(), S = a.call(this, e,
                    n).slice(), x = f.call(this, e, n).slice(), T = d3.scale.linear().domain(d3.extent(d3.merge([
                    l,
                    y
                ]))).range(r ? [p, 0] : [0, p]), N = this.__chart__ || d3.scale.linear().domain([
                        0,
                        Infinity
                    ]).range(T.range());
                this.__chart__ = T;
                ...
                _.select("rect.nv-rangeMax").attr("height", m).attr("width", P(k > 0 ? k : C)).attr("x",
                    B(k > 0 ? k : C)).datum(k > 0 ? k : C), _.select("rect.nv-rangeAvg").attr("height", m).attr("width",
                    P(L)).attr("x", B(L)).datum(L), _.select("rect.nv-rangeMin").attr("height", m).attr("width",
                    P(k)).attr("x", B(k)).attr("width", P(k > 0 ? C : k)).attr("x",
                    B(k > 0 ? C : k)).datum(k > 0 ? C : k), _.select("rect.nv-measure").style("fill", d).attr("height",
                    m / 3).attr("y", m / 3).attr("width", w < 0 ? T(0) - T(w[0]) : T(w[0]) - T(0)).attr("x",
                    B(w)).on("mouseover", function()
                {
    ...
    }, e.models.cumulativeLineChart = function()
    {
        ...
        function _(b)
        {
            return b.each(function(b)
            {
                ...
                var P = d3.select(this).classed("nv-chart-" + S,
                    !0), H = this, B = (f || parseInt(P.style("width")) || 960) - u.left - u.right, j = (l || parseInt(P.style("height")) || 400) - u.top - u.bottom;
                _.update = function()
                {
                ...
                var b = D(O.i,
                    b), V = g ? "none" : "all", $ = P.selectAll("g.nv-wrap.nv-cumulativeLine").data([b]), J = $.enter().append("g").attr("class",
                ...
                J.append("g").attr("class", "nv-interactive"), J.append("g").attr("class",
                    ...
                    "nv-controlsWrap"), c && (i.width(B), K.select(".nv-legendWrap").datum(b).call(i), u.top != i.height() && (u.top = i.height(), j = (l || parseInt(P.style("height")) || 400) - u.top - u.bottom), K.select(".nv-legendWrap").attr("transform",
                    "translate(0," + -u.top + ")"));
                if (m) {
                ...
                $.select(".tempDisabled").remove(), G.length && $.append("text").attr("class", "tempDisabled").attr("x",
                    B / 2).attr("y", "-.71em").style("text-anchor", "end").text(G.map(function(e)
                    {
                        return e.key
                    }).join(", ") + " values cannot be calculated for this time period."), g && (o.width(B).height(j).margin({
                    left: u.left,
                    top: u.top
                }).svgContainer(P).xScale(w), $.select(".nv-interactive").call(o)), J.select(".nv-background").append("rect"), K.select(".nv-background rect").attr("width",
                ...
                et.enter().append("line").style("stroke-width", 2).style("stroke-dasharray", "10,10").style("stroke",
                    function(e, n)
                    {
                ...
                nt.enter().append("rect").attr("class", "nv-indexLine").attr("width", 3).attr("x", -2).attr("fill",
                    "red").attr("fill-opacity", .5).style("pointer-events", "all").call(I), nt.attr("transform",
                    function(e)
                    {
                        return "translate(" + A(e.i) + ",0)"
                    }).attr("height", j), h && (n.scale(w).ticks(Math.min(b[0].values.length, B / 70)).tickSize(-j,
                ...
                }), o.dispatch.on("elementMousemove", function(i)
                {
                    ...
                    }).forEach(function(n, r)
                    {
                        ...
                        typeof s == "undefined" && (s = o), typeof l == "undefined" && (l = _.xScale()(_.x()(o,
                            f))), c.push({key: n.key, value: _.y()(o, f), color: a(n, n.seriesIndex)})
                    });
                    if (c.length > 2) {
        ...
        function D(e, n)
        {
            return n.map(function(n, r)
            {
                ...
                return i < -0.95 ? (n.tempDisabled = !0, n) : (n.tempDisabled = !1, n.values = n.values.map(function(
                    e,
                    n
                )
                {
        ...
        var t = e.models.line(), n = e.models
            .axis(), r = e.models.axis(), i = e.models.legend(), s = e.models.legend(), o = e.interactiveGuideline(), u = {
            top: 30,
            right: 30,
            bottom: 50,
            left: 60
        ...
        var A = d3.scale.linear(), O = {i: 0, x: 0}, M = function(i, s)
        {
            var o = i.pos[0] + (s.offsetLeft || 0), u = i.pos[1] + (s.offsetTop || 0), a = n.tickFormat()(t.x()(i.point,
                i.pointIndex)), f = r.tickFormat()(t.y()(i.point, i.pointIndex)), l = b(i.series.key, a, f, i, _);
        ...
        {
            v && e.tooltip.cleanup()
        }), _.dispatch = k, _.lines = t, _.legend = i, _.xAxis = n, _.yAxis = r, _.interactiveLayer = o, d3.rebind(_, t,
            "defined", "isArea", "x", "y", "xScale", "yScale", "size", "xDomain", "yDomain", "xRange", "yRange",
            "forceX", "forceY", "interactive", "clipEdge", "clipVoronoi", "useVoronoi",
            "id"), _.options = e.utils.optionsFunc.bind(_), _.margin = function(e)
        {
    ...
    }, e.models.discreteBarChart = function()
    {
        ...
        function w(e)
        {
            return e.each(function(e)
            {
                ...
                C.append("g").attr("class", "nv-x nv-axis"), C.append("g").attr("class",
                    "nv-y nv-axis"), C.append("g").attr("class", "nv-barsWrap"), L.attr("transform",
                ...
                f && (r.scale(v).ticks(S / 36).tickSize(-E,
                    0), L.select(".nv-y.nv-axis").transition().call(r)), g.on("tooltipShow", function(e)
                {
                    h && b(e, p.parentNode)
                })
            }), w
        ...
        {
            var o = i.pos[0] + (s.offsetLeft || 0), u = i.pos[1] + (s.offsetTop || 0), a = n.tickFormat()(t.x()(i.point,
                i.pointIndex)), f = r.tickFormat()(t.y()(i.point, i.pointIndex)), l = p(i.series.key, a, f, i, w);
        ...
        {
            h && e.tooltip.cleanup()
        }), w.dispatch = g, w.discretebar = t, w.xAxis = n, w.yAxis = r, d3.rebind(w, t, "x", "y", "xDomain", "yDomain",
            "xRange", "yRange", "forceX", "forceY", "id", "showValues",
        ...
        function w(E)
        {
            return E.each(function(w)
            {
                ...
                s.domain(d || d3.extent(w[0].values.map(u).concat(f))), c ? s.range(m || [
                    ...
                    ]) : s.range(m || [0, E]), o.domain(v || d3.extent(w[0].values.map(a).concat(l))).range(g || [
                        S,
                        0
    ...
    }, e.models.historicalBarChart = function()
    {
        ...
        function x(e)
        {
            return e.each(function(d)
            {
                ...
                D.transition().call(t), l && (n.scale(v).tickSize(-k, 0), _.select(".nv-x.nv-axis").attr("transform",
                    "translate(0," + m.range()[0] + ")"), _.select(".nv-x.nv-axis").transition().call(n)), c && (r.scale(m).ticks(k / 36).tickSize(-C,
                    0), _.select(".nv-y.nv-axis").transition().call(r)), i.dispatch.on("legendClick", function(t, n)
                {
        ...
        var S = function(i, s)
        {
            ...
            var f = i.pos[0] + (s.offsetLeft || 0), l = i.pos[1] + (s.offsetTop || 0), c = n.tickFormat()(t.x()(i.point,
                i.pointIndex)), h = r.tickFormat()(t.y()(i.point, i.pointIndex)), p = d(i.series.key, c, h, i, x);
            ...
            return e.each(function(e)
            {
                ...
                l.forEach(function(e, t)
                {
                    ...
                    t == 0 && n.append("img").classed("nv-treeicon", !0).classed("nv-folded", A).attr("src",
                        L).style("width", "14px").style("height", "14px").style("padding", "0 1px").style("display",
                        function(e)
                        {
        ...
        function m(g)
        {
            return g.each(function(m)
            {
                ...
                L.enter().append("g").style("stroke-opacity", 1e-6).style("fill-opacity",
                    1e-6), L.exit().transition().style("stroke-opacity", 1e-6).style("fill-opacity",
                    1e-6).remove(), L.attr("class", function(e, t)
                {
                    return "nv-group nv-series-" + t
                }).classed("hover", function(e)
                {
                ...
                O.enter().append("path").attr("class", "nv-line").attr("d",
                    ...
                    {
                        return e.utils.NaNtoZero(v(u(t, n)))
                    })), L.exit().selectAll("path.nv-line").transition().attr("d",
                    d3.svg.line().interpolate(p).defined(a).x(function(t, n)
                    {
                        return e.utils.NaNtoZero(c(o(t, n)))
                    }).y(function(t, n)
    ...
    }, e.models.lineChart = function()
    {
        ...
        function N(m)
        {
            return m.each(function(m)
            {
                ...
                D.append("rect").style("opacity", 0), D.append("g").attr("class",
                    ...
                    A), l && (i.width(L), P.select(".nv-legendWrap").datum(m).call(i), o.top != i.height() && (o.top = i.height(), A = (f || parseInt(C.style("height")) || 400) - o.top - o.bottom), _.select(".nv-legendWrap").attr("transform",
                ...
                H.transition().call(t), c && (n.scale(g).ticks(L / 100).tickSize(-A,
                    ...
                    0), P.select(".nv-y.nv-axis").transition().call(r)), i.dispatch.on("stateChange", function(e)
                {
        ...
        {
            var o = i.pos[0] + (s.offsetLeft || 0), u = i.pos[1] + (s.offsetTop || 0), a = n.tickFormat()(t.x()(i.point,
                i.pointIndex)), f = r.tickFormat()(t.y()(i.point, i.pointIndex)), l = m(i.series.key, a, f, i, N);
            e.tooltip.show([o, u], l, null, null, s)
        };
        return t.dispatch.on("elementMouseover.tooltip", function(e)
        {
        ...
        }), S.on("tooltipHide", function()
        {
            ...
            "defined", "isArea", "x", "y", "size", "xScale", "yScale", "xDomain", "yDomain", "xRange", "yRange",
    ...
    }, e.models.lineWithFocusChart = function()
    {
        ...
        function k(e)
        {
            return e.each(function(e)
            {
                ...
                d3.transition(F).call(n), r.scale(v).ticks(A / 100).tickSize(-O,
                    0), i.scale(m).ticks(O / 36).tickSize(-A, 0), H.select(".nv-focus .nv-x.nv-axis").attr("transform",
        ...
        var C = function(n, s)
        {
            var o = n.pos[0] + (s.offsetLeft || 0), u = n.pos[1] + (s.offsetTop || 0), a = r.tickFormat()(t.x()(n.point,
                n.pointIndex)), f = i.tickFormat()(t.y()(n.point, n.pointIndex)), l = S(n.series.key, a, f, n, k);
            e.tooltip.show([o, u], l, null, null, s)
        };
        return t.dispatch.on("elementMouseover.tooltip", function(e)
        {
        ...
        function B(e)
        {
            return e.each(function(e)
            {
                ...
                function it()
                {
                    ...
                    U.length ? C = r.xScale() : C = t.xScale(), s.scale(C).ticks(F / 100).tickSize(-I, 0), s.domain([
                        Math.ceil(S[0]),
                        Math.floor(S[1])
                        ...
                        0), J.select(".nv-focus .nv-y2.nv-axis").style("opacity", z.length ? 1 : 0).attr("transform",
                ...
                tt.selectAll("rect").attr("height", q), tt.selectAll(".resize").append("path").attr("d",
                    nt), o.ticks(F / 100).tickSize(-q, 0), J.select(".nv-context .nv-x.nv-axis").attr("transform",
                    "translate(0," + O.range()[0] + ")"), J.select(".nv-context .nv-x.nv-axis").transition().call(o), f.scale(O).ticks(q / 36).tickSize(-F,
                    0), J.select(".nv-context .nv-y1.nv-axis").style("opacity", U.length ? 1 : 0).attr("transform",
                    "translate(0," + k.range()[0] + ")"), J.select(".nv-context .nv-y1.nv-axis").transition().call(f), l.scale(M).ticks(q / 36).tickSize(U.length ? 0 : -F,
                    0), J.select(".nv-context .nv-y2.nv-axis").style("opacity", z.length ? 1 : 0).attr("transform",
    ...
    }, e.models.multiBarChart = function()
    {
        ...
        function A(e)
        {
            return e.each(function(e)
            {
                ...
                if (h) {
                    ...
                    }).selectAll("text, line").style("opacity", 0), g && q.selectAll(".tick text").attr("transform",
                ...
                p && (r.scale(E).ticks(_ / 36).tickSize(-M,
                    0), j.select(".nv-y.nv-axis").transition().call(r)), i.dispatch.on("stateChange", function(e)
                {
        ...
        {
            var o = i.pos[0] + (s.offsetLeft || 0), u = i.pos[1] + (s.offsetTop || 0), a = n.tickFormat()(t.x()(i.point,
                i.pointIndex)), f = r.tickFormat()(t.y()(i.point, i.pointIndex)), l = b(i.series.key, a, f, i, A);
            e.tooltip.show([o, u], l, i.value < 0 ? "n" : "s", null, s)
        };
        return t.dispatch.on("elementMouseover.tooltip", function(e)
        {
        ...
        {
            y && e.tooltip.cleanup()
        }), A.dispatch = N, A.multibar = t, A.legend = i, A.xAxis = n, A.yAxis = r, d3.rebind(A, t, "x", "y", "xDomain",
            "yDomain", "xRange", "yRange", "forceX", "forceY", "clipEdge", "id", "stacked", "stackOffset", "delay",
            "barColor", "groupSpacing"), A.options = e.utils.optionsFunc.bind(A), A.margin = function(e)
        {
    ...
    }, e.models.multiBarHorizontal = function()
    {
        ...
        function N(e)
        {
            return e.each(function(e)
            {
                ...
                s.domain(y || d3.merge(C).map(function(e)
                    ...
                    }).concat(f))), d && !p ? o.range(E || [
                        o.domain()[0] < 0 ? v : 0,
                        i - (o.domain()[1] > 0 ? v : 0)
                    ]) : o.range(E || [0, i]), x = x || s, T = T || d3.scale.linear().domain(o.domain()).range([
                        o(0),
                        o(0)
                    ]);
                var k = d3.select(this).selectAll("g.nv-wrap.nv-multibarHorizontal").data([e]), L = k.enter().append("g").attr("class",
                    "nvd3 nv-wrap nv-multibarHorizontal"), A = L.append("defs"), O = L.append("g"), M = k.select("g");
                O.append("g").attr("class", "nv-groups"), k.attr("transform",
                    "translate(" + t.left + "," + t.top + ")");
                ...
                _.enter().append("g").style("stroke-opacity", 1e-6).style("fill-opacity",
                    1e-6), _.exit().transition().style("stroke-opacity", 1e-6).style("fill-opacity",
                    1e-6).remove(), _.attr("class", function(e, t)
                {
                    return "nv-group nv-series-" + t
                }).classed("hover", function(e)
                {
                ...
                {
                    return "translate(" + T(p ? t.y0 : 0) + "," + (p ? 0 : r * s.rangeBand() / e.length + s(u(t,
                            n))) + ")"
                });
                P.append("rect").attr("width", 0).attr("height", s.rangeBand() / (p ? 1 : e.length)), D.on("mouseover",
                    function(t, n)
                    {
        ...
        {
            return e.y
        }, f = [0], l = e.utils.defaultColor(), c = null, h, p = !1, d = !1, v = 60, m = d3.format(",.2f"), g = 1200, y, b, w, E, S = d3.dispatch("chartClick",
            "elementClick", "elementDblClick", "elementMouseover", "elementMouseout"), x, T;
    ...
    }, e.models.multiBarHorizontalChart = function()
    {
        ...
        function T(e)
        {
            return e.each(function(h)
            {
                ...
                if (!h || !h.length || !h.filter(function(e)
                    ...
                    return A.enter().append("text").attr("class", "nvd3 nv-noData").attr("dy",
                        "-.7em").style("text-anchor", "middle"), A.attr("x", o.left + C / 2).attr("y",
                        o.top + k / 2).text(function(e)
                    {
                        return e
                    }), T
                }
                d.selectAll(".nv-noData").remove(), v = t.xScale(), m = t.yScale();
                var O = d.selectAll("g.nv-wrap.nv-multiBarHorizontalChart").data([h]), M = O.enter().append("g").attr("class",
                    "nvd3 nv-wrap nv-multiBarHorizontalChart").append("g"), _ = O.select("g");
                M.append("g").attr("class", "nv-x nv-axis"), M.append("g").attr("class",
                    "nv-y nv-axis"), M.append("g").attr("class", "nv-barsWrap"), M.append("g").attr("class",
                    "nv-legendWrap"), M.append("g").attr("class",
                    "nv-controlsWrap"), c && (i.width(C - E()), t.barColor() && h.forEach(function(e, t)
                {
                    e.color = d3.rgb("#ccc").darker(t * 1.5).toString()
                }), _.select(".nv-legendWrap").datum(h).call(i), o.top != i.height() && (o.top = i.height(), k = (a || parseInt(d.style("height")) || 400) - o.top - o.bottom), _.select(".nv-legendWrap").attr("transform",
                    "translate(" + E() + "," + -o.top + ")"));
                if (l) {
                ...
                P.transition().call(t), n.scale(v).ticks(k / 24).tickSize(-C,
                    0), _.select(".nv-x.nv-axis").transition().call(n);
                var H = _.select(".nv-x.nv-axis").selectAll("g");
                H.selectAll("line, text").style("opacity", 1), r.scale(m).ticks(C / 100).tickSize(-k,
                    0), _.select(".nv-y.nv-axis").attr("transform",
                    "translate(0," + k + ")"), _.select(".nv-y.nv-axis").transition().call(r), i.dispatch.on("stateChange",
                    function(e)
                    {
        ...
        }, v, m, g = {stacked: h}, y = null, b = "No Data Available.", w = d3.dispatch("tooltipShow", "tooltipHide",
            "stateChange", "changeState"), E = function()
        {
            return l ? 180 : 0
        }, S = 250;
        ...
        {
            var o = i.pos[0] + (s.offsetLeft || 0), u = i.pos[1] + (s.offsetTop || 0), a = n.tickFormat()(t.x()(i.point,
                i.pointIndex)), f = r.tickFormat()(t.y()(i.point, i.pointIndex)), l = d(i.series.key, a, f, i, T);
        ...
        {
            p && e.tooltip.cleanup()
        }), T.dispatch = w, T.multibar = t, T.legend = i, T.xAxis = n, T.yAxis = r, d3.rebind(T, t, "x", "y", "xDomain",
            "yDomain", "xRange", "yRange", "forceX", "forceY", "clipEdge", "id", "delay", "showValues", "valueFormat",
            "stacked", "barColor"), T.options = e.utils.optionsFunc.bind(T), T.margin = function(e)
        {
        ...
        function C(e)
        {
            return e.each(function(e)
            {
                ...
                F.append("g").attr("class", "x axis"), F.append("g").attr("class",
                    ...
                    "stack1Wrap"), F.append("g").attr("class", "stack2Wrap"), F.append("g").attr("class", "legendWrap");
                var I = j.select("g");
        ...
        function x(e)
        {
            return e.each(function(e)
            {
                ...
                }).attr("d", function(t, n)
                {
                    ...
                    return "m0,0l0," + (o(f(t, n)) - o(c(t, n))) + "l" + -r / 2 + ",0l" + r / 2 + ",0l0," + (o(h(t,
                            n)) - o(f(t, n))) + "l0," + (o(l(t, n)) - o(h(t, n))) + "l" + r / 2 + ",0l" + -r / 2 + ",0z"
                }).attr("transform", function(e, t)
                {
    ...
    }, e.models.pie = function()
    {
        ...
        function E(e)
        {
            return e.each(function(e)
            {
                ...
                var o = n - t.left - t.right, f = r - t.top - t.bottom, E = Math.min(o,
                        f) / 2, S = E - E / 5, x = d3.select(this), T = x.selectAll(".nv-wrap.nv-pie").data(e), N = T.enter().append("g").attr("class",
                    "nvd3 nv-wrap nv-pie nv-chart-" + u), C = N.append("g"), k = T.select("g");
                C.append("g").attr("class", "nv-pie"), T.attr("transform",
                    "translate(" + t.left + "," + t.top + ")"), k.select(".nv-pie").attr("transform",
                    "translate(" + o / 2 + "," + f / 2 + ")"), x.on("click", function(e, t)
                {
                ...
                if (l) {
                    ...
                    c && (D = L), h && (D = d3.svg.arc().outerRadius(L.outerRadius())), M.append("g").classed("nv-label",
                        !0).each(function(e, t)
                    {
                        ...
                        }), n.append("rect").style("stroke", "#fff").style("fill", "#fff").attr("rx", 3).attr("ry",
                            3), n.append("text").style("text-anchor",
                            m ? (e.startAngle + e.endAngle) / 2 < Math.PI ? "start" : "end" : "middle").style("fill",
                            "#000")
                    ...
                    {
                        var n = d3.select(this);
                        n.select(".nv-label text").style("text-anchor",
                            m ? (e.startAngle + e.endAngle) / 2 < Math.PI ? "start" : "end" : "middle").text(function(
                            e,
                            t
                        )
                        {
                        ...
                        n.select(".nv-label rect").attr("width", r.width + 10).attr("height",
                            r.height + 10).attr("transform", function()
                        {
        ...
        }, u = Math.floor(Math.random() * 1e4), a = e.utils.defaultColor(), f = d3.format(",.2f"), l = !0, c = !0, h = !1, p = "key", d = .02, v = !1, m = !1, g = !1, y = !1, b = .5, w = d3.dispatch("chartClick",
            "elementClick", "elementDblClick", "elementMouseover", "elementMouseout");
        ...
        function I(q)
        {
            return q.each(function(I)
            {
                ...
                J.append("g").attr("class", "nv-groups"), J.append("g").attr("class",
                    ...
                    q).attr("height", R), K.attr("clip-path", S ? "url(#nv-edge-clip-" + s + ")" : ""), F = !0;
        ...
        function F(e)
        {
            return e.each(function(e)
            {
                    ...
                    "translate(" + (E ? L : -u.size()) + ",0)").datum(e.filter(function(e)
                {
                    ...
                    I), X.select(".nv-background").on("mousemove", K), X.select(".nv-background").on("click", function()
                {
                    T = !T
        ...
        function B(e)
        {
            return e.each(function(e)
            {
                ...
                U.append("rect").attr("class", "nvd3 nv-background").style("pointer-events",
                    ...
                    "nv-regressionLinesWrap"), U.append("g").attr("class", "nv-distWrap"), U.append("g").attr("class",
                    "nv-legendWrap"), U.append("g").attr("class", "nv-controlsWrap"), q.attr("transform",
                    ...
                    "translate(" + (b ? C : -u.size()) + ",0)").datum(e.filter(function(e)
                {
                    ...
                    j), z.select(".nv-background").on("mousemove", $), z.select(".nv-background").on("click", function()
                {
                    S = !S
                }), t.dispatch.on("elementClick.freezeFisheye", function()
                {
                ...
                })), s.dispatch.on("legendClick", function(e, i)
                {
                    e.disabled = !e.disabled, E = e.disabled ? 0 : 2.5, z.select(".nv-background").style("pointer-events",
                        ...
                        e.disabled ? "all" : "none"), e.disabled ? (h.distortion(E).focus(0), p.distortion(E).focus(0), z.select(".nv-scatterWrap"
        ...
        function v(e)
        {
            return e.each(function(c)
            {
                ...
                function M()
                {
                    function r(e, n)
                    {
                        ...
                        for (var s = 0; s < e.length; s++) {
                            Math.abs(t.x()(e[s], s) - n) < r && (r = Math.abs(t.x()(e[s],
                                    s) - n), i = s);
                        }
                        return i
                    }
                ...
                A.enter().append("text").attr("class", "nv-currentValue").attr("dx", p ? -8 : 8).attr("dy",
                    ".9em").style("text-anchor", p ? "end" : "start"), A.attr("x", g + (p ? n.right : 0)).attr("y",
                    h ? function(e)
                    {
                        return o(e)
                    } : 0).style("fill", t.color()(c[c.length - 1],
                    c.length - 1)).text(l(E)), N.select(".nv-hoverArea").append("rect").on("mousemove", M).on("click",
                    function()
                    {
                        a = !a
                    }).on("mouseout", function()
    ...
    }, e.models.stackedAreaChart = function()
    {
        ...
        function M(y)
        {
            return y.each(function(y)
            {
                ...
                I.append("rect").style("opacity", 0), I.append("g").attr("class",
                    ...
                    "nv-controlsWrap"), I.append("g").attr("class", "nv-interactive"), q.select("rect").attr("width",
                    P).attr("height", H);
                if (h) {
                    var R = c ? P - C : P;
        ...
        {
            var o = i.pos[0] + (s.offsetLeft || 0), u = i.pos[1] + (s.offsetTop || 0), a = n.tickFormat()(t.x()(i.point,
                i.pointIndex)), f = r.tickFormat()(t.y()(i.point, i.pointIndex)), l = y(i.series.key, a, f, i, M);
            e.tooltip.show([o, u], l, i.value < 0 ? "n" : "s", null, s)
        };
