    ...
    $.fn.button = function(option)
    {
        return this.each(function()
        {
            ...
            data || $this.data("button",
                data = new Button(this, options)), "toggle" == option ? data.toggle() : option && data.setState(option)
        })
    ...
    Modal.prototype = {
        ...
        }, backdrop: function(callback)
        {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                !this.isShown && this.$backdrop ? (this.$backdrop.removeClass("in"), $.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one($.support.transition.end,
    ...
    Tooltip.prototype = {
        constructor: Tooltip, init: function(type, element, options)
        {
            ...
            this.type = type, this.$element = $(element), this.options = this.getOptions(options), this.enabled = !0, "click" == this.options.trigger ? this.$element.on("click." + this.type,
                ...
                this.options.selector, $.proxy(this.leave, this))), this.options.selector ? this._options = $.extend({},
