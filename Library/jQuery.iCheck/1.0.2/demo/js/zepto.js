...
var Zepto = function()
{
    ...
    {
        for (g in b) {
            d && (k( b[g] ) || t( b[g] )) ? (k( b[g] ) && !k( a[g] ) && (a[g] = {}), t( b[g] ) && !t( a[g] ) && (a[g] = []), C( a[g],
                b[g], d )) : b[g] !== f && (a[g] = b[g])
        }
    }
    ...
    n.init = function( a, b )
    {
        if (a) {
            ...
            var d;
            if (t( a )) {
                d = D.call( a, function( a )
                {
                    return null != a
                } );
            } else {
                if (q( a )) {
                    d = [k( a ) ? c.extend( {}, a ) : a], a = null;
                } else {
                    if (N.test( a )) {
                        d = n.fragment( a.trim(), RegExp.$1, b ), a = null;
                    } else {
                        if (b !== f) {
                            return c( b ).find( a );
                        }
    ...
    c.fn = {
        ...
        closest: function( a, b )
        {
            ...
            for ("object" == typeof a && (e = c( a )); d && !(e ? 0 <= e.indexOf( d ) :
                n.matches( d, a ));) {
                d = d !== b && !s( d ) && d.parentNode;
            }
            return c( d )
        },
        parents: function( a )
        {
            for (var b = [], d = this; 0 < d.length;) {
                d = c.map( d, function( a )
                {
                    if ((a = a.parentNode) && !s( a ) && 0 > b.indexOf( a )) {
                        return b.push( a ), a
                    }
                } );
            }
        ...
        show: function()
        {
            return this.each( function()
            {
                ...
                if ("none" == J( this, "" ).getPropertyValue( "display" )) {
                    ...
                    I[b] || (d = v.createElement( b ), v.body.appendChild( d ), c = J( d,
                        "" ).getPropertyValue( "display" ), d.parentNode.removeChild( d ), "none" == c && (c = "block"), I[b] = c);
                    a.display =
                        I[b]
                }
            } )
        ...
        wrap: function( a )
        {
            var b = m( a );
            if (this[0] && !b) {
                var d = c( a ).get( 0 ), e = d.parentNode || 1 < this.length;
            }
            ...
            return "string" == typeof a && b === f ? 0 == this.length || 1 !== this[0].nodeType ? f : "value" == a && "INPUT" == this[0].nodeName ? this.val() : !(d = this[0].getAttribute( a )) && a in this[0] ? this[0][a] : d : this.each( function( d )
            {
                if (1 === this.nodeType) {
                    if (q( a )) {
                        ...
                        d = x( this, b, d,
                            this.getAttribute( a ) ), null == d ? this.removeAttribute( a ) : this.setAttribute( a, d )
                    }
                }
            } )
        },
        ...
        )
        {
            if (2 > arguments.length && "string" == typeof a) {
                return this[0] && (this[0].style[L( a )] || J( this[0],
                        "" ).getPropertyValue( a ));
            }
            var d = "";
            if ("string" == h( a )) {
                !b && 0 !== b ? this.each( function()
                {
                    this.style.removeProperty( j( a ) )
                } ) : d = j( a ) + ":" + ("number" == typeof b && !M[j( a )] ? b + "px" : b);
            } else {
                for (g in a) {
                    !a[g] && 0 !== a[g] ? this.each( function()
                    {
        ...
        offsetParent: function()
        {
            return this.map( function()
            {
                for (var a = this.offsetParent || v.body; a && !O.test( a.nodeName ) && "static" == c( a ).css( "position" );) {
                    a = a.offsetParent;
                }
                return a
            } )
...
(function( h )
{
        ...
        q( f, g, function( f, g )
        {
            ...
            j.e in C && (g = function( e )
            {
                ...
                if (!c || c !== this && !h.contains( this, c )) {
                    return j.fn.apply( this, arguments )
                }
            });
            j.del = u && u( g, f );
            var k = j.del || g;
        ...
        return this.each( function( c, j )
        {
            k( j, f, g, e, function( c )
            {
                return function( f )
                {
                    ...
                    if (k) {
                        return g = h.extend( l( f ), {currentTarget: k, liveFired: j} ), c.apply( k,
                            [g].concat( [].slice.call( arguments, 1 ) ) )
                    }
                }
            } )
        } )
    ...
    {
        if ("string" == typeof e || h.isPlainObject( e )) {
            e = h.Event( e );
        }
        var g = e;
...
(function( h )
{
    ...
    function p( l, j, m )
    {
        ...
        if (!(p = s[q])) {
            ...
            {
                0 == l.name.indexOf( "data-" ) && (y[k( l.name.replace( "data-",
                    "" ) )] = h.zepto.deserializeValue( l.value ))
            } );
            p = p[q] = y
        }
        l = p;
