...
if (!isset($GLOBALS['Piwik_SearchEngines'])) {
    $GLOBALS['Piwik_SearchEngines'] = array(
        ...
        'apollo7.de' => array(
            'Apollo7',
            'query',
            'a7db/index.php?query={k}&de_sharelook=true&de_bing=true&de_witch=true&de_google=true&de_yahoo=true&de_lycos=true'
        ),
        ...
        // Google Cache
        'webcache.googleusercontent.com' => array(
            'Google',
...
//		'google.com/gwt/n'			=> array('Google Wireless Transcoder'),
        ...
        'wsdsold.infospace.com' => array(
            'InfoSpace',
            '/\/[^\/]+\/ws\/results\/[^\/]+\/([^\/]+)/',
            'pemonitorhosted/ws/results/Web/{k}/1/417/TopNavigation/Source/'
        ),
        ...
        // MySpace
        'searchservice.myspace.com' => array(
            'MySpace',
            'qry',
            'index.cfm?fuseaction=sitesearch.results&type=Web&qry={k}'
        ),

        // MySearch / MyWay / MyWebSearch (default: powered by Ask.com)
        'www.mysearch.com' => array(
            'MyWebSearch',
            array('searchfor', 'searchFor'),
            'search/Ajmain.jhtml?searchfor={k}'
        ),
