 ...
 * Class PhoneLink
 *
 * @package SPHERE\Common\Frontend\PhoneLink\Repository
 */
class PhoneLink extends Extension implements ILinkInterface
{
    ...
    public function __construct($Name, $Path, IIconInterface $Icon = null, $Data = array(), $ToolTip = false)
    {
        ...
        $this->Name = $Name;
        $this->Path = $Path;
        $this->Template = $this->getTemplate(__DIR__.'/PhoneLink.twig');
