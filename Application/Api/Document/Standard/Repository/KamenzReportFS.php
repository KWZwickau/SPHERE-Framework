...
use SPHERE\Application\Api\Document\Standard\Repository\KamenzReportFS\S02_2;
...
use SPHERE\Application\Api\Document\Standard\Repository\KamenzReportFS\S04_2;
use SPHERE\Application\Api\Document\Standard\Repository\KamenzReportFS\S04_2_1;
...
class KamenzReportFS extends AbstractDocument
{
    ...
    public function buildDocument($pageList = array())
    {
        return (new Frame())->addDocument((new Document())
            ...
            ->addPage((new Page())
                ->addSliceArray(S02_2::getContent('S02_2'))
            )
            ->addPage((new Page())
                ->addSliceArray(S02_2::getContent('S02_2_1'))
            )
            ->addPage((new Page())
                ->addSliceArray(S02::getContent('S03_1'))
            )
            ->addPage((new Page())
                ->addSliceArray(S02_2::getContent('S03_2'))
            )
            ->addPage((new Page())
                ->addSliceArray(S04::getContent())
            )
            ->addPage((new Page())
                ->addSliceArray(S04_1_1::getContent())
            )
            ->addPage((new Page())
                ->addSliceArray(S04_2::getContent())
            )
            ->addPage((new Page())
                ->addSliceArray(S04_2_1::getContent())
            )
        );
    }
}