...
/**
 * Class ApiAccidentReport
 * @package SPHERE\Application\Api\Document\Standard\Repository\AccidentReport
 */
class ApiAccidentReport extends Extension implements IApiInterface
{
    ...
    {
        return (new BlockReceiver($Content))->setIdentifier('Download AccidentReport');
    }
