...
class B01_1
{
    ...
    public static function getContent()
    {
        ...
        $sliceList[] = (new Slice())
            ...
            ->addElement((new Element())
                ->setContent(
                    'B01.1 Darunter Abgänger/ Absolventen, deren Herkunftssprache nicht oder nicht ausschließlich Deutsch
                ...
                ->addSliceColumn((new Slice())
                    ...
                    ->addSection((new Section())
                        ->addElementColumn((new Element())
                            ...
                            , '50%')
                        ->addElementColumn((new Element())
                            ->setContent('darunter zusätzlich<br/>zuerkannter<br/>mittlerer Schulabschluss')
                            ->styleBorderRight()
                            ->styleBorderBottom()
                            , '50%')
                    )
        ...
        for ($i = 0; $i < 6; $i++) {
            ...
            $section
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.Course is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.Course }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
            ...
            $section
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.Time is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.Time }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
            ...
            $section
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.Lesson is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.Lesson }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
            ...
            $section
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.Status is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.Status }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
            ...
            $section
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.Leave.m is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.Leave.m }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
                ...
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.Leave.w is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.Leave.w }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
            ...
            $section
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.DiplomaTotal.m is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.DiplomaTotal.m }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
                ...
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.DiplomaTotal.w is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.DiplomaTotal.w }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
            ...
            $section
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.DiplomaAddition.m is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.DiplomaAddition.m }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
                ...
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.DiplomaAddition.w is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.DiplomaAddition.w }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
            ...
            $section
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.TotalCount.m is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.TotalCount.m }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
                ...
                ->addElementColumn((new Element())
                    ->setContent('
                            {% if (Content.B01_1' . '.R' . $i . '.TotalCount.w is not empty) %}
                                {{ Content.B01_1' . '.R' . $i . '.TotalCount.w }}
                            {% else %}
                                &nbsp;
                            {% endif %}
                        ')
    ...
    private static function getTotalSlice($identifier, $gender, $isLastColumn = false)
    {
        return (new Slice())
            ->addElement((new Element())
                ->setContent('
                        {% if (Content.B01_1.TotalCount.FullTime.Student.' . $identifier . '.' . $gender . ' is not empty) %}
                            {{ Content.B01_1.TotalCount.FullTime.Student.' . $identifier . '.' . $gender . ' }}
                        {% else %}
                            &nbsp;
                        {% endif %}
                    ')
            ...
            ->addElement((new Element())
                ->setContent('
                        {% if (Content.B01_1.TotalCount.FullTime.ChangeStudent.' . $identifier . '.' . $gender . ' is not empty) %}
                            {{ Content.B01_1.TotalCount.FullTime.ChangeStudent.' . $identifier . '.' . $gender . ' }}
                        {% else %}
                            &nbsp;
                        {% endif %}
                    ')
            ...
            ->addElement((new Element())
                ->setContent('
                        {% if (Content.B01_1.TotalCount.PartTime.Student.' . $identifier . '.' . $gender . ' is not empty) %}
                            {{ Content.B01_1.TotalCount.PartTime.Student.' . $identifier . '.' . $gender . ' }}
                        {% else %}
                            &nbsp;
                        {% endif %}
                    ')
            ...
            ->addElement((new Element())
                ->setContent('
                        {% if (Content.B01_1.TotalCount.PartTime.ChangeStudent.' . $identifier . '.' . $gender . ' is not empty) %}
                            {{ Content.B01_1.TotalCount.PartTime.ChangeStudent.' . $identifier . '.' . $gender . ' }}
                        {% else %}
                            &nbsp;
                        {% endif %}
                    ')
