            ...
            ->addSlice((new Slice())
                ...
                ->addSection((new Section())
                    ...
                    ->addSliceColumn((new Slice())
                        ...
                        ->addSection((new Section())
                            ->addSliceColumn($this->getGradeLanesForRadebeul($personId, $textColorBlue, $textSize))
                        )
//                            ->addSection((new Section())
//                                ->addElementColumn((new Element())
...
//                            )
                        ...
                        ->addSection((new Section())
                            ->addSliceColumn($this->getSubjectLanesForRadebeul($personId, $textColorBlue, $textSize))
                        )
                        ->addSection((new Section())
                            ->addElementColumn((new Element())
                                ->setContent('Bemerkungen:')
