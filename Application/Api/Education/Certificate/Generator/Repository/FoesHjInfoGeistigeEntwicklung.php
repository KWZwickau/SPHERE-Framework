...
/**
 * Class FoesHjInfoGeistigeEntwicklung
 *
 * @package SPHERE\Application\Api\Education\Certificate\Generator\Repository
 */
class FoesHjInfoGeistigeEntwicklung extends Certificate
{
    ...
    public function buildPages(TblPerson $tblPerson = null)
    {
        ...
        return (new Page())
            ...
            ->addSlice($this->getFoesLevelAndYear($personId))
            ->addSlice($this->getStudentName($personId))
            ->addSlice($this->getDescriptionWithoutTeamContent($personId, '480px', '20px'))
            ->addSlice((new Slice())
