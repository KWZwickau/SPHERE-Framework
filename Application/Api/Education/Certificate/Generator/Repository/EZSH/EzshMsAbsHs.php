 ...
 */
class EzshMsAbsHs extends EzshStyle
{
    /**
...
//        $pageList[] = new Page();
        ...
        $pageList[] = (new Page())
            ...
            ->addSlice($this->getEZSHSubjectLanes($personId, true, array(), false)->styleHeight('320px'))
            ->addSlice((new Slice())->addSectionList($this->getEZSHRemark($personId, '200px')))
