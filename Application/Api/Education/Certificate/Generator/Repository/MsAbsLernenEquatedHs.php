...
/**
 * Class MsAbsLernenEquatedHs
 *
 * @package SPHERE\Application\Api\Education\Certificate\Generator\Repository
 */
class MsAbsLernenEquatedHs extends Certificate
{
...
//                        )
            ...
            ->addSlice((new Slice())
                ->addElement((new Element())
                    ->setContent('und hat gemäß § 63 Absatz 3 Nummer 2 der Schulordnung Ober- und Abendoberschulen einen dem')
                    ->styleMarginTop('8px')
                    ->styleAlignLeft()
                )
                ->addElement((new Element())
        ...
        $pageList[] = (new Page())
            ...
            ->addSlice($this->getDescriptionContent($personId, '220px', '15px',
                ...
                wurde gemäß § 63 Absatz 2 der Schulordnung Ober- und Abendoberschulen inklusiv nach den Lehrplänen für 
                den Hauptschulbildungsgang der Oberschule unterrichtet. <br>'
            ))
            ->addSlice($this->getDateLine($personId))
            ->addSlice($this->getExaminationsBoard('10px','11px', $personId, 'Hauptschulabschluss gleichgestellten Abschluss'))
            ->addSlice($this->getInfo($this->CopyCertificateData ? '45px' : '170px',
                'Notenerläuterung:',
