...
class Data extends AbstractData
{
    public function setupDatabaseContent()
    {
        ...
        $this->createSetting(TblSetting::IDENT_DEBTOR_EXTENDED_VIEW, '0', TblSetting::TYPE_BOOLEAN, TblSetting::CATEGORY_REGULAR);
        $this->createSetting(TblSetting::IDENT_CAUSER_EXTENDED_VIEW, '0', TblSetting::TYPE_BOOLEAN, TblSetting::CATEGORY_REGULAR);
