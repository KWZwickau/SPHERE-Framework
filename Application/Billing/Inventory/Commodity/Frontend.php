                                ...
                                new FormGroup(
                                    new FormRow( array(
                                        new FormColumn(
                                            ...
                                            , 7 ),
                                        new FormColumn(
                                            new \SPHERE\Common\Frontend\Form\Repository\Button\Primary( 'Hinzufügen', new Plus() )
                                            , 5 )
                                    ) )
                                ), null,
                    ...
                    new Layout( array(
                        new LayoutGroup( array(
                            new LayoutRow( array(
                                ...
                                new LayoutColumn(
                                    new Panel( 'Beschreibung', $tblCommodity->getDescription(), Panel::PANEL_TYPE_SUCCESS ), 8
                                )
                            ) ) ) ),
                        new LayoutGroup( array(
                            new LayoutRow( array(
