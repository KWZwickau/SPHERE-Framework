...
//
//                $paymentType = $tblInvoice->getServiceTblPaymentType();
//                $Temp['PaymentType'] = "";
//                if ($paymentType) {
//                    $Temp['PaymentType'] = $paymentType->getName();
//                }
//                $Temp['Person'] = $tblInvoice->getServiceTblPerson()->getFullName();
...
//        }
     ...
     * @return Stage
     */
    public function frontendOrderEdit($Id = null)
    {
...
//                                            $tblDebtor->getServiceTblPerson())) > 1
//                                            ? new Standard('',
...
//                    }
//
//                    if ($tblInvoice->getServiceTblPaymentType()->getName() === 'SEPA-Lastschrift') {
//                        if ($tblAccount) {
            ...
            new Layout(array(
                new LayoutGroup(array(
                    ...
                    new LayoutRow(array(
                        ...
                        new LayoutColumn(
                            new Panel('Person', $tblInvoice->getServiceTblPerson()->getFullName()), 3
                        )
                    )),
                    new LayoutRow(array(
                        new LayoutColumn(
                            ( $tblInvoice->getServiceTblAddress()
                                ? new Panel(
                                    new MapMarker().' Rechnungsadresse', array(
                                    $tblInvoice->getServiceTblAddress()->getStreetName().' '.$tblInvoice->getServiceTblAddress()->getStreetNumber().'<br/>'.
                                    $tblInvoice->getServiceTblAddress()->getTblCity()->getCode().' '.$tblInvoice->getServiceTblAddress()->getTblCity()->getName()
                                ),
                                    Panel::PANEL_TYPE_DEFAULT
                                )
                                : new Warning(
                        ...
                        new LayoutColumn(
                            new Panel(
                                'Zahlungsart',
                                $tblInvoice->getServiceTblPaymentType()->getName(),
                                Panel::PANEL_TYPE_DEFAULT
                            ), 3
                        ),
                    )),
...
//            Banking::useService()->getDebtorByDebtorNumber($tblOrder->getDebtorNumber())->getServiceTblPerson());
//
...
//        );
     ...
     * @return Stage
     */
    public function frontendInvoicePaymentTypeChange($Id = null, $PaymentType = null)
    {
...
//        $Stage->setContent(Invoice::useService()->changeInvoicePaymentType($tblInvoice, $tblPaymentType));
     ...
     * @return Stage
     */
    public function frontendOrderItemChange($Id, $IdItem)
    {
