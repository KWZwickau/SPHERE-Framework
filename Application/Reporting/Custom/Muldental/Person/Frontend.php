...
class Frontend extends Extension implements IFrontendInterface
{
    ...
    public function frontendClassList($level = null)
    {
        ...
        $Route = '/Reporting/Custom/Muldental/Person/ClassList';
        ...
        if($level === null){
            ...
            if(($TableContent = Person::useService()->createClassList($tblPersonList))) {
                $Stage->addButton(
                    new Primary('Herunterladen', '/Api/Reporting/Custom/Muldental/Common/ClassList/Download', new Download(), array('level' => $level))
                );
