...
use SPHERE\Application\Education\Graduation\Grade\Grade as GradeApplication;
...
//                            'Name' => 'Fehlzeit hinzufügen',
                            'Url' => strtolower('https://' . $_SERVER['HTTP_HOST'] . '/App/Education/Grade/OnlineGradeBook/Load'),
                            'Parameters' => [
...
//                        'Type' => 'RecentGrades',
                        'loadRecentGradesContent' => [
                            'Method' => 'GET',
//                            'Name' => 'Fehlzeit hinzufügen',
                            'Url' => strtolower('https://' . $_SERVER['HTTP_HOST'] . '/App/Education/Grade/OnlineGradeBook/RecentGrades/Load'),
                            'Parameters' => [
//                                'AccountId' => ($tblAccount = Account::useService()->getAccountBySession()) ? $tblAccount->getId() : null,
                                'YearId' => $tblYear->getId()
                            ]
            ...
            foreach ($tblPersonList as $tblPerson) {
                if (($tblStudentEducation = DivisionCourse::useService()->getStudentEducationByPersonAndYear($tblPerson, $tblYear))) {
                    $result[] = array(
                        ...
                        'SubjectList' => GradeApplication::useService()->getStudentOverviewDataByPerson($tblPerson, $tblYear, $tblStudentEducation, true, false, true),
                        'Links' => [],
                    );
                }
            }
