...
class Frontend extends Extension implements IFrontendInterface
{
    ...
    public function frontendStudentImport($File = null)
    {
        ...
        $Stage = new Stage('Import Tharandt', 'Schüler-Daten Gymnasium');
        $Stage->addButton(
            new Standard(
                'Zurück',
                '/Transfer/Import',
            ...
            new Layout(
                new LayoutGroup(
                    new LayoutRow(
                        new LayoutColumn(array(
                            new Well(
                                Tharandt::useService()->createStudentsFromFile(new Form(
                                    new FormGroup(
                                        new FormRow(
                                            new FormColumn(
                                                new FileUpload('File', 'Datei auswählen', 'Datei auswählen', null,
            ...
            new Layout(
                new LayoutGroup(
                    new LayoutRow(
                        new LayoutColumn(array(
                            new Well(
                                Tharandt::useService()->createInterestedFromFile(new Form(
                                    new FormGroup(
                                        new FormRow(
                                            new FormColumn(
                                                new FileUpload('File', 'Datei auswählen', 'Datei auswählen', null,
