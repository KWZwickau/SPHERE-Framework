...
/**
 * @Entity
 * @Table(name="tblUntisImportStudentCourse")
 * @Cache(usage="READ_ONLY")
 */
class TblUntisImportStudentCourse extends Element
{
    ...
    const ATTR_TBL_UNTIS_IMPORT_STUDENT = 'tblUntisImportStudent';
     ...
     * @Column(type="bigint")
     */
    protected $tblUntisImportStudent;
    ...
    /**
     * @return bool|TblUntisImportStudent
     */
    public function getTblUntisImportStudent()
    {
        if (null === $this->tblUntisImportStudent) {
            return false;
        } else {
            return Import::useService()->getUntisImportStudentById($this->tblUntisImportStudent);
        }
    }
