...
class Data extends AbstractData
{
    ...
    public function setupDatabaseContent()
    {
        ...
        $this->createSetting('People', 'Person', 'Student', 'ShowUnderage', TblSetting::TYPE_BOOLEAN, '0',
            'Allgemein', 'Anzeige Icon nach Schülernamen im Klassenbuch und Notenbuch ob minderjährig oder volljährig gesteuert nach Schulart [Standard: Nein]', true);
