...
//        $this->setNameDefinition(self::TBL_GROUP_DESCRIPTION, 'Beziehung: Kategorie-Bemerkung');
    ...
    public function loadViewGraph()
    {
        ...
        $this->addForeignView(self::TBL_TO_PERSON_SERVICE_TBL_PERSON_FROM, new ViewAddressToPerson(),
            ViewAddressToPerson::TBL_TO_PERSON_SERVICE_TBL_PERSON);
        $this->addForeignView(self::TBL_TO_PERSON_SERVICE_TBL_PERSON_FROM, new ViewMailToPerson(),
            ViewMailToPerson::TBL_TO_PERSON_SERVICE_TBL_PERSON);
        $this->addForeignView(self::TBL_TO_PERSON_SERVICE_TBL_PERSON_FROM, new ViewPhoneToPerson(),
