...
//        $this->addForeignView(self::TBL_CUSTODY_SERVICE_TBL_PERSON, new ViewDivisionStudent(), ViewDivisionStudent::TBL_DIVISION_STUDENT_SERVICE_TBL_PERSON);
        ...
        $this->addForeignView(self::TBL_CUSTODY_SERVICE_TBL_PERSON, new ViewAddressToPerson(),
            ViewAddressToPerson::TBL_TO_PERSON_SERVICE_TBL_PERSON);
        $this->addForeignView(self::TBL_CUSTODY_SERVICE_TBL_PERSON, new ViewMailToPerson(),
            ViewMailToPerson::TBL_TO_PERSON_SERVICE_TBL_PERSON);
        $this->addForeignView(self::TBL_CUSTODY_SERVICE_TBL_PERSON, new ViewPhoneToPerson(),
