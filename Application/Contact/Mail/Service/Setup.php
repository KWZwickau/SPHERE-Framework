...
class Setup extends AbstractSetup
{
    ...
    private function setTableToPerson(Schema &$Schema, Table $tblMail, Table $tblType)
    {
        ...
        $this->createColumn($Table, 'IsAccountBackupMail', self::FIELD_TYPE_BOOLEAN, false, false);

        //ToDO Clean Up SR
//        $this->createColumn($Table, 'IsAccountRecoveryMail', self::FIELD_TYPE_BOOLEAN, false, false);
