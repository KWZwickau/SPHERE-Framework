                    ...
                    foreach ($tblStudentList as $tblPerson) {
                        if(!$isGroup || ($tblGroup && Group::useService()->existsGroupPerson($tblGroup, $tblPerson))) {
                            ...
                            $studentTable[] = array(
                                ...
                                ?
                                    (new Standard(
                                    'Block I', '/Education/Certificate/Prepare/Prepare/Diploma/Abitur/BlockI', new Cog(),
                                    array(
                                        'PrepareId' => $tblPrepare->getId(),
                                        'GroupId' => $tblGroup ? $tblGroup->getId() : null,
                                        'PersonId' => $tblPerson->getId(),
...
//                    "searching" => false, // Deaktivieren Suchen
    ...
    public function frontendPrepareDiplomaAbiturBlockI(
        ...
        $stage = new Stage('Abiturzeugnis', 'Block I bearbeiten');
        $stage->addButton(
            new Standard('Zurück', '/Education/Certificate/Prepare/Prepare/Diploma/Abitur/Preview', new ChevronLeft(), array(
                'PrepareId' => $PrepareId,
                'GroupId' => $GroupId,
                'Route' => 'Diploma'
            ))
        ...
        if (($tblPerson = Person::useService()->getPersonById($PersonId))
            ...
            list ($advancedCourses, $basicCourses) = $this->setCourses($tblPerson, $tblDivision);
            ...
            if (($tblDivisionStudentList = Division::useService()->getDivisionStudentAllByPerson($tblPerson))) {
                foreach ($tblDivisionStudentList as $tblDivisionStudent) {
                    if (($tblDivision = $tblDivisionStudent->getTblDivision())
                        ...
                        foreach ($tblPrepareList as $tblPrepareItem) {
                            if ($tblPrepareItem->getServiceTblGenerateCertificate()
                                && ($tblCertificateType = $tblPrepareItem->getServiceTblGenerateCertificate()->getServiceTblCertificateType())
                                ...
                                $midTerm = '-1';
                                if (($tblAppointedDateTask = $tblPrepareItem->getServiceTblAppointedDateTask())
                                    && ($tblDivisionItem = $tblPrepareItem->getServiceTblDivision())
         ...
         */
        $dataList = array();
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Deutsch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Sorbisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Englisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Französisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Griechisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Italienisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Latein');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Polnisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Russisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Spanisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Tschechisch');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, '&nbsp;');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Kunst');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Musik');
         ...
         */
        $dataList = array();
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Geschichte');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList,
            'Gemeinschaftskunde/Rechtserziehung/Wirtschaft');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Geographie');
         ...
         */
        $dataList = array();
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Mathematik');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Biologie');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Chemie');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Physik');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, '&nbsp;');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList,
            $tblReligionSubject
                ? $tblReligionSubject->getName() : 'Ev./Kath. Religion/Ethik');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Sport');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, '&nbsp;');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Astronomie');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Informatik');
        $dataList = $this->setSubjectRow($dataList, $advancedCourses, $basicCourses, $prepareStudentList, 'Philosophie');
     ...
     * @param $basicCourses
     * @param $prepareStudentList
     * @param $subjectName
     * @return array
     */
    private function setSubjectRow($array, $advancedCourses, $basicCourses, $prepareStudentList, $subjectName)
    {
        ...
        if (($tblSubject = Subject::useService()->getSubjectByName($subjectName))) {
            ...
            if (isset($advancedCourses[$tblSubject->getId()])) {
                $subjectName = new Bold ($subjectName);
                $course = new Bold('LK');
            }
            if (isset($basicCourses[$tblSubject->getId()])) {
                $subjectName = new Bold ($subjectName);
                $course = 'GK';
            }
            ...
            for ($level = 11; $level < 13; $level++){
                for ($term = 1; $term < 3; $term++) {
                    $midTerm = $level . '-' . $term;
                    if (isset($prepareStudentList[$midTerm])) {
                        /** @var TblPrepareStudent $tblPrepareStudent */
                        $tblPrepareStudent = $prepareStudentList[$midTerm];
     ...
     * @return array
     */
    private function setCourses(TblPerson $tblPerson, TblDivision $tblDivision)
    {
