...
class Service extends Extension
{
                    ...
                    foreach ($tblDivisionList as $tblDivision) {
                        ...
                        if (($tblStudentList = Division::useService()->getStudentAllByDivision($tblDivision))) {
                            foreach ($tblStudentList as $tblPerson) {
                                ...
                                $this->getGrades($item, $subjectList, $tblPerson, $tblPrepareHalfYear, $tblPrepareDiploma);
     ...
     */
    private function getGrades(array &$item, array &$subjectList, TblPerson $tblPerson, ?TblPrepareCertificate $tblPrepareHalfYear, ?TblPrepareCertificate $tblPrepareDiploma)
    {
