...
//            'Content.Input.FoesAbsText'         => 'SelectBox', // SSW-1685 Auswahl soll aktuell nicht verfügbar sein, bis aufweiteres aufheben
    ...
    public function getFormLabel(TblType $tblType = null): array
    {
        ...
        return array(
            ...
            'Content.Input.SubareaTimeH1'        => 'Teilbereich 1 Dauer der Ausbildung (Tage)',
            'Content.Input.SubareaTimeHDone1'   => 'Teilbereich 1 Davon anwesend (Tage)',
            'Content.Input.Subarea2'            => 'Teilbereich 2',
            'Content.Input.SubareaTimeH2'        => 'Teilbereich 2 Dauer der Ausbildung (Tage)',
            'Content.Input.SubareaTimeHDone2'   => 'Teilbereich 2 Davon anwesend (Tage)',
            'Content.Input.Subarea3'            => 'Teilbereich 3',
            'Content.Input.SubareaTimeH3'        => 'Teilbereich 3 Dauer der Ausbildung (Tage)',
            'Content.Input.SubareaTimeHDone3'   => 'Teilbereich 3 Davon anwesend (Tage)',
            'Content.Input.Subarea4'            => 'Teilbereich 4',
            'Content.Input.SubareaTimeH4'        => 'Teilbereich 4 Dauer der Ausbildung (Tage)',
            'Content.Input.SubareaTimeHDone4'   => 'Teilbereich 4 Davon anwesend (Tage)',
            // Fachschule
