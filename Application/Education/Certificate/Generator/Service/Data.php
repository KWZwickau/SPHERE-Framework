...
class Data extends AbstractData
{
    ...
    private $tblSchoolTypeBerufsschule;
     ...
     * @return TblType
     */
    public function getTblSchoolTypeBerufsschule()
    {
        return $this->tblSchoolTypeBerufsschule;
    }
...
//        SDataGym::setCertificateStandard($this);
        ...
        // Korrektur der Namen
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjInfoHs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahresinformation', 'Hauptschule');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjInfo'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahresinformation', 'Klasse 5-6');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjInfoRs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahresinformation', 'Realschule');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjInfoFsLernen'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahresinformation', 'Förderschwerpunkt Lernen');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjFsLernen'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahreszeugnis', 'Förderschwerpunkt Lernen');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsJFsLernen'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Jahreszeugnis', 'Förderschwerpunkt Lernen');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjInfoFsGeistigeEntwicklung'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahresinformation', 'Förderschwerpunkt geistige Entwicklung');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjFsGeistigeEntwicklung'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahreszeugnis', 'Förderschwerpunkt geistige Entwicklung');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsJFsGeistigeEntwicklung'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Jahreszeugnis', 'Förderschwerpunkt geistige Entwicklung');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjHs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahreszeugnis', 'Hauptschule');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsHjRs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Halbjahreszeugnis', 'Realschule');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsJHs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Jahreszeugnis', 'Hauptschule');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsJ'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Jahreszeugnis', 'Klasse 5-6');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsJRs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Jahreszeugnis', 'Realschule');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsAbsHs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Abschlusszeugnis', 'Hauptschule');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsAbsHsQ'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Abschlusszeugnis', 'Hauptschule qualifiziert');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsAbsRs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Abschlusszeugnis', 'Realschule');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsAbg'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Abgangszeugnis', '');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsAbgLernen'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Abgangszeugnis', 'Förderschwerpunkt Lernen');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsAbgLernenHs'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Abgangszeugnis', 'Förderschwerpunkt Lernen + Hauptschulbildungsgang');
        }
        if(($tblCertificate = $this->getCertificateByCertificateClassName('MsAbgGeistigeEntwicklung'))){
            $this->updateCertificateName($tblCertificate, 'Oberschule Abgangszeugnis', 'Förderschwerpunkt geistige Entwicklung');
        }
