...
class GSJGSHJInfo extends Extension implements IFrontendInterface
{
            ...
            ->addSection(
                (new Section())
                    ->addElementColumn((new Element())
                        ->setContent('GS HalbjahreszeugnisInfo /Zeugnis Klasse 1 1a.pdf')
                        ->styleTextSize('12px')
                        ->styleTextColor('#CCC')
                        ->styleAlignCenter()
                        , '25%')
            ...
            ->addPage((new Page())
                ...
                ->addSlice((new Slice())
                    ->addElement((new Element())
                        ->setContent('Halbjahresinformation/Jahreszeugnis¹ der Grundschule')
                        ->styleTextSize('18px')
                        ->styleTextBold()
                        ->styleAlignCenter()
                        ->styleMarginTop('15px')
