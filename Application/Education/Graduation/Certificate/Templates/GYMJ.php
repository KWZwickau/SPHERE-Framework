...
class GYMJ extends Extension implements IFrontendInterface
{
                    ...
                    ->addSection((new Section())
                        ->addElementColumn((new Element())
                            ->setContent('Notenerläuterung:<br/>
                                          ...
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Beim spreachlichen Profil ist der Zusatz "mit informatischer Bildung" zu streichen und die Fremdsprache anzugeben.')
                            ->styleTextSize('9.5px')
                            , '30%')
                    )
                )
