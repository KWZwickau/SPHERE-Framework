...
class GYMHJ extends Extension implements IFrontendInterface
{
            ...
            ->addPage((new Page())
                ...
                ->addSlice((new Slice())
                    ->addElement((new Element())
                        ->setContent('Halbjahresinformation/Halbjahreszeugnis¹ des Gymnasiums')
                        ->styleTextSize('18px')
                        ->styleTextBold()
                        ->styleAlignCenter()
                        ->styleMarginTop('15px')
                    ...
                    ->addSection((new Section())
                        ->addElementColumn((new Element())
                            ->setContent('Notenerläuterung:<br/>
                                          ...
                                          ³ &nbsp;&nbsp;&nbsp; Gilt nur für das Halbjahreszeugnis.')
                            ->styleTextSize('9.5px')
                            , '30%')
                    )
                )
