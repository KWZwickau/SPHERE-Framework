...
class Node8 extends AbstractNode
{

    protected function parseResult($List, $Timeout = 60)
    {

        array_walk($List[7], function (Element $Node7) use (&$Result, $List) {

            array_walk($List[6], function (Element $Node6) use (&$Result, $List, $Node7) {

                array_walk($List[5], function (Element $Node5) use (&$Result, $List, $Node6, $Node7) {

                    array_walk($List[4], function (Element $Node4) use (&$Result, $List, $Node5, $Node6, $Node7) {

                        array_walk($List[3],
                            function (Element $Node3) use (&$Result, $List, $Node4, $Node5, $Node6, $Node7) {

                                array_walk($List[2],
                                    function (Element $Node2) use (
                                        &$Result,
                                        $List,
                                        $Node3,
                                        $Node4,
                                                ...
                                                array_walk($List[0],
                                                    function (Element $Node0) use (
                                                        ...
                                                        if (
                                                            ...
                                                            && ( $Data6[$this->getPath(6)[1]] == $Data7[$this->getPath(7)[0]] )
                                                        ) {
                                                            $Result[] = array(
                                                                $Node0,
                                                                $Node1,
